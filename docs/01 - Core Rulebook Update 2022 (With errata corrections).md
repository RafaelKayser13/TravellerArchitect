...
| CREDITS | CONTENTS |
| :--- | :--- |
| **CLASSIC TRAVELLER** | **INTRODUCTION** | 03 |
| Marc Miller | **TRAVELLER CREATION** | 08 |
| **MONGOOSE TRAVELLER** | **SKILLS AND TASKS** | 58 |
| **DEVELOPER** | **COMBAT** | 73 |
| Matthew Sprange | **ENCOUNTERS AND DANGERS** | 80 |
| **ORIGINAL CORE MECHANICS** | **EQUIPMENT** | 97 |
| Gareth Hanrahan | **VEHICLES** | 136 |
| **ADDITIONAL PSIONICS TEXT** | **SPACECRAFT OPERATIONS** | 149 |
| Kelly Kollman | **SPACE COMBAT** | 164 |
| **LAYOUT** | **SPACECRAFT CONSTRUCTION** | 176 |
| Katrina Hepburn, Sandrine Thirache | **COMMON SPACECRAFT** | 188 |
| **ILLUSTRATIONS** | **PSIONICS** | 228 |
| Xavier Bernard, Sergio Villa, Anderson Maia, Mark Graham, Nikita Vasylchuk, Douglas Deri, Ian Stead, Ankit Yadav, Cassie Gregory, Alessandro Rocco | **TRADE** | 238 |
| **PROOFING** | **WORLD AND UNIVERSE CREATION** | 246 |
| Charlotte Law | | |
...
Traveller ©2024 Mongoose Publishing Ltd. All rights reserved. Reproduction of this work by any means without the written permission of the publisher is expressly forbidden. All significant characters, names, places, items, art and text herein are copyrighted by Mongoose Publishing Ltd.
...
TRAVELLER is a registered trade mark of Mongoose Publishing Ltd.
...
![Imagem de dois planetas no espaço, um maior em primeiro plano com um brilho solar, e um menor ao fundo, com nebulosas vermelhas e escuras. Duas naves triangulares pairam sobre a superfície iluminada de um planeta abaixo.](https://i.imgur.com/8Y9g0qL.png)
...
**The Explorer Campaign:** In a campaign of this type the Travellers go beyond the borders of Charted Space, looking for objects, planets and civilisations of value or curiosity. The Travellers will have to be highly self-sufficient to survive on their own for long stretches. For inspiration look no further than the original series of *Star Trek*.
...
Specialised types of campaign are detailed in two expansions – *Mercenary* and *Element Class Cruisers*. *Mercenary* shows Travellers how to recruit and fight with a dedicated military unit, allowing them to make their fortune with a platoon or company of soldiers. Meanwhile, *Element Class Cruisers* includes the *Naval Campaign Sourcebook*, which provides everything needed to run a ‘bridge crew’ style of campaign, where the Travellers will be the senior officers of a mighty capital ship!
...
## Robot Handbook: Advanced civilisations build automated servants to perform the most arduous, mundane or dangerous tasks. The *Robot Handbook* provides a complete construction system for mechanical servants, from simple domestic droids to huge and powerful war robots that can dominate battlefields. Also included are many robots, ready to populate your universes.
...
A quick discussion of terminology and conventions is needed before proceeding. *Traveller* uses two six-sided dice to resolve most actions. Some situations involve fewer or more dice.
...
Even on a less advanced world, there might be examples of higher technology. A warlord on a primitive planet might enforce their rule with advanced weapons imported from offworld; colony worlds are often dependent on their sponsor civilisation for supplies and support. Some low-technology worlds are aware of the larger universe and have consciously decided to reject advanced technology.
...
| :--- | :--- |
| **TL8 (Pré-Estelar)** | Em TL8, é possível alcançar outros mundos no mesmo sistema estelar, embora a terraformação ou colonização total não estejam dentro da capacidade da cultura. Habitats espaciais permanentes tornam-se possíveis. A energia de fusão torna-se comercialmente viável. |
| **TL9 (Pré-Estelar)** | O elemento definidor de TL9 é o desenvolvimento da manipulação da gravidade, o que torna a viagem espacial vastamente mais segura e rápida. Esta pesquisa leva ao desenvolvimento do *jump drive*, que ocorre perto do final deste Nível Tecnológico. Culturas TL9 podem colonizar outros mundos, embora viajar para uma colônia seja frequentemente uma viagem só de ida. |
| **TL10 (Estelar Inicial)** | Com o advento de *jump drives* comumente disponíveis, sistemas vizinhos são abertos. Habitats orbitais e fábricas tornam-se comuns. A viagem interestelar e o comércio levam a um *boom* econômico. Colônias tornam-se muito mais viáveis. |
| **TL11 (Estelar Inicial)** | As primeiras inteligências artificiais verdadeiras tornam-se possíveis, pois os computadores são capazes de modelar redes sinápticas. Estruturas suportadas pela gravidade alcançam os céus. A viagem *Jump-2* torna-se possível, permitindo viagens mais fáceis além dos principais *jumps* estelares. |
| **TL12 (Estelar Médio)** | O controle climático em todo o planeta revoluciona a terraformação e a agricultura. Armas de plasma portáteis e armas de fusão montadas em transportadores tornam o campo de batalha insustentável para combatentes desarmados. O *Jump-3* é desenvolvido. |
| **TL13 (Estelar Médio)** | O traje de batalha aparece no campo de batalha em resposta a novas armas, anunciando o auge da armadura pessoal e tornando a infantaria o equivalente de veículos blindados avançados. A clonagem de partes do corpo torna-se fácil. O *Jump-4* aparece. |
| **TL14 (Estelar Médio)** | Armas de fusão tornam-se portáteis. Cidades voadoras aparecem. *Jump-5 drives* são construídos. |
| **TL15 (Estelar Alto)** | Geradores de globo negro sugerem uma nova direção para tecnologias defensivas, enquanto o desenvolvimento de anagátics sintéticos significa que a expectativa de vida humana aumentou vastamente. |
| | Níveis Tecnológicos mais Altos existem (de fato, não há limite teórico superior) e podem aparecer em outros universos ou ser descobertos por cientistas pioneiros no Espaço Cartografado. |

*(Imagem de ilustração de dois personagens, um com capacete e outro sem, em um cenário de ficção científica.)*
...
| Noble Titles | | |
| :--- | :--- | :--- |
| **Social Standing** | **Possible Titles** | |
| 11 | Knight | |
| 12 | Baron | |
| 13 | Marquis | |
| 14 | Count | |
...
| | |
| :--- | :--- |
| **STRENGTH** DM | **INTELLECT** DM |
| **DEXTERITY** DM | **EDUCATION** DM |
| **ENDURANCE** DM | **SOCIAL** DM |
...
| SKILL | TRAINING PERIOD COMPLETE | STUDY PERIOD |
| :--- | :--- | :--- |
| Admin ( ) | Explosives ( ) | Pilot ( ) |
| Advocate ( ) | Flyer ( ) | Pilot ( ) |
| Animals ( ) | Flyer ( ) | Pilot ( ) |
| Animals ( ) | Gun Combat ( ) | Profession ( ) |
| Animals ( ) | Gun Combat ( ) | Profession ( ) |
| Art ( ) | Gun Combat ( ) | Profession ( ) |
| Art ( ) | Gun Combat ( ) | Recon ( ) |
| Art ( ) | Gun Combat ( ) | Science ( ) |
| Astrogation ( ) | Gun Combat ( ) | Science ( ) |
| Athletics ( ) | Hvy Weapons ( ) | Science ( ) |
| Athletics ( ) | Hvy Weapons ( ) | Seafarer ( ) |
| Athletics ( ) | Hvy Weapons ( ) | Seafarer ( ) |
| Broker ( ) | Jack of all Trades | Seafarer ( ) |
| Carouse ( ) | Investigate | Stealth |
| Deception ( ) | Language | Steward |
| Diplomat ( ) | Language | Streetwise |
| Drive ( ) | Language | Survival |
| Drive ( ) | Leadership | Tactics ( ) |
| Drive ( ) | Mechanic | Tactics ( ) |
| Electronics ( ) | Medic | Vacc Suit |
| Electronics ( ) | Melee ( ) | |
| Electronics ( ) | Melee ( ) | |
| Engineer ( ) | Navigation | |
| Engineer ( ) | Persuade | |
...
| | |
| :--- | :--- |
| **PENSION:** Cr. | **MONTHLY SHIP PAYMENTS:** Cr. |
| **DEBT:** Cr. | **CASH ON HAND:** Cr. |
| | **LIVING COST:** Cr. |

| TYPE | ARMOUR | RAD | PROTECTION | KG | OPTIONS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | |

## WEAPONS

| WEAPON | TL | RANGE | DAMAGE | KG | MAGAZINE |
| :--- | :--- | :--- | :--- | :--- | :--- |
| | | | | | |
...
**Equipment:** Anything that you carry that is not armour or a weapon is noted here. A full list of equipment can be found on page 97.
...
**Armour:** This provides protection against attacks and, sometimes, radiation. See page 100 for more details.
...
## Background Notes
Here you can detail any additional information about your Traveller that may be relevant. Experiences that changed their outlook on life, personality quirks or psycological traits are just a few examples.

## Wounds
Any long-term wounds your Traveller may be suffering from, including any medication they need, can be listed here.

## Personal Data File
All of your Traveller's vital statistics at a glance a second time for efficiency. With a spot for a selfie!

## People You Know
During your career, you may meet many Allies, Contacts, Enemies and Rivals. Remember them, as they may appear in a later adventure.

## Previous History
A personal history of the Traveller to date including careers, awards and decorations.

---

## TRAVELLER CHARACTER SHEET

| BACKGROUND NOTES | PERSONAL DATA FILE |
| :--- | :--- |
| | **TITLE:** |
| **ALLIES** | **NAME:** |
| NAME: | NOTES: | **RACE:** |
| | **UNIVERSAL CHARACTER PROFILE** |
| | STR | END | EDU |
| **CONTACTS** | DEX | INT | SOC |
| NAME: | NOTES: | **WOUNDS** | |
| | TYPE | LOCATION | RECOVERY PERIOD | NOTES |
| **RIVALS** | | **PREVIOUS HISTORY** |
| NAME: | NOTES: | |
| **ENEMIES** | | |
| NAME: | NOTES: | |
...
## CHARACTERISTICS
- Roll 2D for every characteristic.
- Calculate dice modifier.

## BACKGROUND
- Choose EDU DM+3 background skills.
- Choose a homeworld.

## PRE-CAREER EDUCATION (OPTIONAL)
- Choose University or Military Academy and roll for entry.
- Gain skills.
- Roll for an event.
- Roll for graduation. Gain graduation benefits if successful.

## START NEW TERM
Choose career and roll for qualification:
- If failed, roll for draft or choose drifter career: page 19.

If this is your first term, go through basic training. Otherwise choose a skill table and roll.

## MUSTERING OUT
- Roll for benefits/cash.
If this is your final muster out: resolve pension and medical debt (page 48).

## SURVIVAL
- Roll for survival.

If failed, roll for a mishap and leave career unless otherwise stated, in which case go back to 'Start new term'.
...
### SKILL PACKAGE
- Choose a skill package with your fellow Travellers (page 50).

### EVENT
- Roll for an event.
- Connect to another Traveller?

### ADVANCEMENT
If commission is possible and you wish to try:
- Army, Navy or Marines for commission if first term or SOC 9+
Roll for advancement (page 18).

### CONTINUE?
- Increase age by +4 years.
- Choose whether to continue Traveller creation
    If this is an option:
    - Choose whether to continue in the same career.
    If so, go back to Start New term.
    If another career is chosen:
    - Muster out before starting the new career (page 46).
    If required:
    - Roll for aging (page 48).
...
Admin, Advocate, Animals (training or veterinary), Art (any), Astrogration, Electronics (any), Engineer (any), Language (any), Medic, Navigation, Profession (any), Science (any).

Increase EDU by +1

**Graduation:** INT 6+. If 10+ is rolled, graduate with honours.
...
* Graduation allows a commission roll to be taken before the first term of a military career, so long as it is the first career chosen after university. Success will mean the Traveller enters the career at officer rank 1. If graduation was with honours, DM+2 is granted on this first commission roll.
...
**Entry:** Army END 7+, Marines END 8+, Navy INT 8+
DM-2 in Term Two, DM-4 if in Term Three.

**Skills:** Gain all Service Skills of the military career the academy is tied to at level 0, as with basic training.

**Graduation:**
INT 7+. If 11+ is rolled, graduate with honours.
DM+1 if END 8 or higher, DM+1 if SOC 8 or higher.
...
* Graduation allows a commission roll to be taken before the first term of a military career, so long as it is the first career chosen after university, with DM+2. Success will mean the Traveller enters the career at officer rank 1. If graduation was with honours, the Traveller will automatically pass this roll.
...
To enter a new career, a Traveller need only make the appropriate qualification roll at the start of the new term. If they fail, they must either submit to the draft (if they have not already done so earlier in life) or become a Drifter.
...
| Career | Assignment | Qualification | Survival | Advancement | Page |
|---|---|---|---|---|---|
| Agent | Law Enforcement | INT 6+ | END 6+ | INT 6+ | 22 |
| | Intelligence | | INT 7+ | INT 5+ | |
| | Corporate | | INT 5+ | INT 7+ | |
| Army | Support | END 5+ | END 5+ | EDU 7+ | 24 |
| | Infantry | | STR 6+ | EDU 6+ | |
| | Cavalry | | DEX 7+ | INT 5+ | |
| Citizen | Corporate | EDU 5+ | SOC 6+ | INT 6+ | 26 |
| | Worker | | END 4+ | EDU 8+ | |
| | Colonist | | INT 7+ | END 5+ | |
| Drifter | Barbarian | | END 7+ | STR 7+ | 28 |
| | Wanderer | Automatic | INT 7+ | INT 7+ | |
| | Scavenger | | DEX 7+ | END 7+ | |
| Entertainer | Artist | DEX or INT 5+ | SOC 6+ | INT 6+ | 30 |
| | Journalist | | EDU 7+ | INT 5+ | |
| | Performer | | INT 5+ | DEX 7+ | |
| Marine | Support | END 6+ | END 5+ | EDU 7+ | 32 |
| | Star Marine | | END 6+ | EDU 6+ | |
| | Ground Assault | | END 7+ | EDU 5+ | |
| Merchant | Merchant Marine | INT 4+ | | EDU 5+ | INT 7+ | 34 |
| | Free Trader | | DEX 6+ | INT 6+ | |
| | Broker | | EDU 5+ | INT 7+ | |
| Navy | Line/Crew | INT 6+ | INT 5+ | EDU 7+ | 36 |
| | Engineer/Gunner | | INT 6+ | EDU 6+ | |
| | Flight | | DEX 7+ | EDU 5+ | |
| Noble | Administrator | SOC 10+ | INT 4+ | EDU 6+ | 38 |
| | Diplomat | | INT 5+ | SOC 7+ | |
| | Dilettante | | SOC 5+ | INT 7+ | |
| Rogue | Thief | DEX 6+ | INT 6+ | DEX 6+ | 40 |
| | Enforcer | | END 6+ | STR 6+ | |
| | Pirate | | DEX 6+ | INT 6+ | |
| Scholar | Field Researcher | INT 6+ | END 6+ | INT 6+ | 42 |
| | Scientist | | EDU 4+ | INT 8+ | |
| | Physician | | EDU 4+ | EDU 8+ | |
| Scout | Courier | INT 5+ | END 5+ | EDU 9+ | 44 |
...
| 3 | INT +1 | Investigate | Explosives |
| 4 | Melee | Flyer | Medic |
...
| 2 | Sergeant | — |
| 3 | Detective | Investigate 1 |
| 4 | Lieutenant | Admin 1 |
| 5 | Chief | SOC +1 |
| 6 | Commissioner | — |

### RANK 0-6: INTELLIGENCE/CORPORATE

| RANK | INTELLIGENCE/CORPORATE | SKILL OR BONUS |
| :--- | :--- | :--- |
| 0 | Agent | Deception 1 |
| 1 | Field Agent | Investigate 1 |
| 2 | — | — |
| 3 | Special Agent | Gun Combat 1 |
...
| 3 | You are sent to a very unpleasant region (jungle, swamp, desert, icecap, urban) to battle against guerilla fighters and rebels. You are discharged because of stress, injury or because the government wishes to bury the whole incident. Increase Recon or Survival by one level but also gain the rebels as an Enemy. |
...
| 1D | Advocate | Drive | Animals |
| 1 | Admin | Mechanic | Athletics |
| 2 | Broker | Electronics | Jack-of-all-Trades |
| 3 | Electronics (computers) | Engineer | Drive |
| 4 | Diplomat | Profession | Survival |
| 5 | Leadership | Science | Recon |
| 6 | | | |
...
| RANK | WORKER | SKILL OR BONUS | RANK | COLONIST | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | — | — | 0 | — | — |
| 1 | — | — | 1 | — | — |
| 2 | Technician | Profession 1 | 2 | Settler | Survival 1 |
| 3 | — | — | 3 | — | — |
| 4 | Craftsman | Mechanic 1 | 4 | Explorer | Navigation 1 |
| 5 | — | — | 5 | — | — |
| 6 | Master Technician | Engineer 1 | 6 | — | Gun Combat 1 |
...
**Barbarian:** You live on a primitive world without the benefits of technology.
...
| RANK | WANDERER | SKILL OR BONUS | RANK | SCAVENGER | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | — | — | 0 | — | — |
| 1 | — | Streetwise 1 | 1 | — | Vacc Suit 1 |
| 2 | — | — | 2 | — | — |
| 3 | — | Deception 1 | 3 | — | Profession (belter) 1 or Mechanic 1 |
| 4 | — | — | 4 | — | — |
| 5 | — | — | 5 | — | — |
| 6 | — | — | 6 | — | — |
...
| 9 | You are offered a chance to take part in a risky but rewarding adventure. If you accept, roll 1D: On a 1–2, you are injured or arrested; either roll on the Injury table or take the Prisoner career in your next term. On a 3–4, you survive, but gain nothing. On a 5–6, you succeed. Gain DM+4 to one Benefit roll. |
...
| RANK | JOURNALIST | SKILL OR BONUS | RANK | PERFORMER | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | | | 0 | | |
| 1 | Freelancer | Electronics (comms) 1 | 1 | | DEX +1 |
| 2 | Staff Writer | Investigate 1 | 2 | | |
| 3 | | | 3 | | STR +1 |
| 4 | Correspondent | Persuade 1 | 4 | | |
| 5 | | | 5 | Famous Performer | SOC +1 |
| 6 | Senior Correspondent | SOC +1 | 6 | | |
...
| 1D | PERSONAL DEVELOPMENT | SERVICE SKILLS | ADVANCED EDUCATION (MIN. EDU 8) | OFFICER (COMMISSIONED ONLY) |
| :--- | :--- | :--- | :--- | :--- |
...
**Merchant Marine:** You work on one of the massive cargo haulers run by the Imperium or a megacorporation.
...
| RANK | FREE TRADER | SKILL OR BONUS | RANK | BROKER | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | — | — | 0 | — | — |
| 1 | — | Persuade 1 | 1 | — | Broker 1 |
| 2 | — | — | 2 | — | — |
| 3 | Experienced Trader | Jack-of-all-Trades 1 | 3 | Experienced Broker | Streetwise 1 |
| 4 | — | — | 4 | — | — |
| 5 | — | — | 5 | — | — |
| 6 | — | — | 6 | — | — |
...
**Line/Crew:** You serve as a general crewman or officer on a ship of the line.
...
| RANK | ENLISTED | SKILL OR BONUS | RANK | OFFICER | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | Crewman | — | 1 | Ensign | Melee (blade) 1 |
| 1 | Able Spacehand | Mechanic 1 | 2 | Sublieutenant | Leadership 1 |
| 2 | Petty Officer, 3rd class | Vacc Suit 1 | 3 | Lieutenant | — |
| 3 | Petty Officer, 2nd class | — | 4 | Commander | Tactics (naval) 1 |
| 4 | Petty Officer, 1st class | END +1 | 5 | Captain | SOC 10 or SOC +1, whichever is higher |
| 5 | Chief Petty Officer | — | 6 | Admiral | SOC 12 or SOC +1, whichever is higher |
| 6 | Master Chief | — | | | |
...
| :--- | :--- |
| 2 | Disaster! Roll on the Mishap table but you are not ejected from this career. |
| 3 | You join gambling circle on board. Gain Gambler 1 or Deception 1. If you wish, throw Gambler 8+. If you succeed, gain an extra Benefit roll from this career; if you fail, you lose one Benefit roll from this career. |
...
| 10 | You have the opportunity to abuse your position for profit. If you do so, gain an extra Benefit roll from this term. Refuse and your DM+2 to your next advancement roll. |
...
**Administrator:** You serve in the planetary government or even ruled over a fiefdom or other domain.
...
| RANK | DIPLOMAT | SKILL OR BONUS | RANK | DILETTANTE | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | Intern | — | 0 | Wastrel | — |
| 1 | 3rd Secretary | Admin 1 | 1 | — | — |
| 2 | 2nd Secretary | — | 2 | Ingrate | Carouse 1 |
| 3 | 1st Secretary | Advocate 1 | 3 | — | — |
| 4 | Counsellor | — | 4 | Black Sheep | Persuade 1 |
| 5 | Minister | Diplomat 1 | 5 | — | — |
| 6 | Ambassador | — | 6 | Scoundrel | Jack-of-all-Trades 1 |
...
| 4 | Political manoeuverings usurp your position. Increase Diplomat or Advocate by one level and gain a Rival. |
...
| RANK | ENFORCER | SKILL OR BONUS | RANK | PIRATE | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | — | — | 0 | Lackey | — |
| 1 | — | Persuade 1 | 1 | Henchman | Pilot 1 or Gunner 1 |
| 2 | — | — | 2 | Corporal | — |
| 3 | — | Gun Combat 1 or Melee 1 | 3 | Sergeant | Gun Combat 1 or Melee 1 |
| 4 | — | — | 4 | Lieutenant | — |
| 5 | — | Streetwise 1 | 5 | Leader | Leadership 1 |
| 6 | — | — | 6 | Captain | — |
...
**Field Researcher:** You are an explorer or field researcher, equally at home in the laboratory or wilderness.
...
| RANK | SCIENTIST | SKILL OR BONUS | RANK | PHYSICIAN | SKILL OR BONUS |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 0 | — | — | 0 | — | — |
| 1 | — | Science 1 | 1 | — | Medic 1 |
| 2 | — | Electronics (computers) 1 | 2 | — | — |
| 3 | — | Investigate 1 | 3 | — | Science 1 |
| 4 | — | — | 4 | — | — |
| 5 | — | Science 2 | 5 | — | Science 2 |
| 6 | — | — | 6 | — | — |
...
| 5 | You have no idea what happened to you – they found your ship drifting on the fringes of friendly space. Injured. Roll on the Injury table (see page 49). |
...
| 12 | **Unusual Event:** Something weird happens. Roll 1D: |
...
<div align="center">
<img src="image_placeholder_TAS_logo.png" alt="TAS Logo">
</div>
...
**Medical Care:** If you have been injured, then medical care may be able to undo the effects of the damage. Some worlds have the technology to clone or rebuild damaged organs; others specialise in transplants or cybernetic replacements. Regardless of the technique used, medical care is expensive.

The restoration of a lost characteristic costs Cr5000 per point.

If you were injured in the service of an organisation, then a portion of your medical care may be paid for. Roll 2D on the Medical Bills table, adding your rank as a DM.
...
For example, Mom suffers an injury during his career as a barbarian, reducing his STR by 2. He has the limb regrown at a starport hospital, at the cost of Cr10000. He has to pay this entire amount himself – but has no money. Mom starts the game with a Cr10000 debt to the hospital.
...
**Skills:**
Deception 1, Electronics 1, Gun Combat 1, Gunner 1, Medic 1 Persuade 1, Pilot 1, Stealth 1
...
**Skills:**
Advocate 1, Astrogation 1, Broker 1, Diplomat 1, Electronics 1, Medic 1, Pilot 1, Streetwise 1
...
**Skills:**
Astrogation 1, Electronics 1, Gun Combat 1, Medic 1, Pilot 1, Recon 1, Stealth 1, Survival 1

## INVESTIGATOR SKILLS PACKAGE
For campaigns centring on solving crimes and investigating mysteries.

**Skills:**
Admin 1, Advocate 1, Deception 1, Electronics 1, Gun Combat 1, Investigate 1, Persuade 1, Stealth 1, Streetwise 1

## MERCENARY SKILLS PACKAGE
This skills package focuses on ground combat and is aimed at combat-heavy games.

**Skills:**
Electronics 1, Medic 1, Leadership 1, Heavy Weapons 1, Gun Combat 1, Gun Combat 1, Stealth 1, Recon 1
...
**Skills:**
Admin 1, Advocate 1, Deception 1, Diplomat 1, Electronics 1, Persuade 1, Stealth 1, Streetwise 1

## CRIMINAL SKILLS PACKAGE
For campaigns involving crime and elaborate heists.

**Skills:**
Broker 1, Deception 1, Electronics 1, Medic 1, Persuade 1, Pilot 1, Stealth 1, Streetwise 1

TRAVELLER CREATION

---

# Ilustração de Ficção Científica: Equipe em Frente a uma Nave Espacial

Esta imagem é uma ilustração vibrante de ficção científica, provavelmente a capa ou arte promocional de um livro, quadrinho ou jogo. Ela retrata um grupo diversificado de personagens em frente a uma nave espacial de aparência robusta, com um cenário de cidade futurista ao fundo.

## Personagens Principais

O grupo é composto por sete indivíduos humanoides e duas criaturas não-humanas, todos vestidos com uniformes táticos escuros, sugerindo que são uma tripulação ou força de segurança.

### Posições e Aparências

*   **Centro-Esquerda (Lobisomem em Pé):** Uma figura humanoide com características lupinas (pêlo, focinho), vestindo armadura escura e segurando uma arma longa (rifle ou espingarda).
*   **Atrás (Homem de Meia-Idade):** Um homem de pele escura, com expressão séria, apoiando a mão no queixo.
*   **Centro-Esquerda (Mulher):** Uma mulher de cabelos escuros, em pose confiante com as mãos na cintura.
*   **Centro (Protagonista Masculino):** Um homem jovem, de cabelo escuro, em pé, vestindo armadura peitoral proeminente.
*   **Centro-Baixo (Lobisomem Agachado):** Outra figura lupina, agachada, com um capuz ou cachecol escuro.
*   **Centro-Direita (Gigante Barbudo):** Um homem muito grande e musculoso, com barba ruiva proeminente e armadura pesada, parecendo um alienígena ou um humano geneticamente modificado.
*   **Direita (Mulher com Braços Cruzados):** Uma mulher de cabelo escuro preso, com armadura nos ombros, em pose desafiadora com os braços cruzados.
*   **Abaixo (Homem Agachado):** Um homem barbudo, agachado, olhando para frente com uma expressão calma.
*   **Mascote/Animal de Estimação:** Ao lado do homem agachado, há uma criatura pequena, quadrúpede, de cor vermelha brilhante, vestindo um pequeno traje ou armadura.

## Cenário e Ambiente

### Nave Espacial
Dominando o plano médio, há uma nave espacial de transporte ou cargueiro, de cor branca ou cinza claro, com um design arredondado e modular, lembrando vagamente modelos clássicos de ficção científica.

### Fundo
O fundo é dramático e atmosférico:
*   **Céu:** O céu é escuro, com um brilho intenso de luz amarela/laranja vindo da esquerda, possivelmente um pôr do sol ou a luz de um motor de nave. Há estrelas e pequenos pontos de luz coloridos (efeito de aberração cromática ou poeira estelar).
*   **Cidade:** À direita, ergue-se uma metrópole futurista densa, com arranha-céus altos e iluminados, sugerindo um planeta ou estação espacial altamente urbanizada.
*   **Tráfego Aéreo:** Pequenas naves voam entre a tripulação e a cidade, reforçando o ambiente de ficção científica espacial.

## Estilo Visual
A arte é digital, com um estilo de pintura detalhado, mas com uma paleta de cores saturada e um forte contraste entre as luzes quentes do horizonte e os tons frios (azul/verde) do céu e da nave.
...
The Prisoner is a special career that Travellers cannot enter voluntarily. Instead, they may be forced to spend time in this career through various events in other careers. A Traveller is free to pick a new assignment in the career every term.
...
![Aslan Dewclaw illustration](Aslan_Dewclaw.png)
...
<div style="text-align: right;">TRAVELLER CREATION</div>
...
| | 6. You are attacked by another prisoner. Roll Melee (unarmed) 8+. If you fail, roll on the Injury table. Reduce your Parole Threshold by 1. |
| 8 | You have the opportunity to hire a new lawyer, with your choice of Advocate skill. They cost Cr1000 x their Advocate level squared. Roll 2D + your lawyer’s Advocate skill; on an 8+, reduce your Parole Threshold by 1D. |
| 9 | Special Duty. You are given a special responsibility in the prison. Gain one of Admin, Advocate, Electronics (computers) or Steward. |
| 10 | The warden takes an interest in your case. Reduce your Parole Threshold by –2. |
| 11 | Heroism. You have the opportunity to save a guard or prison officer. If you take the risk, roll 2D. On a 7 or less, roll on the Injury table. On 8+, gain an Ally and reduce your Parole Threshold by –2. |
| 12 | |
...
Some skills have specialities – specialised, more focused forms of that skill. A Traveller picks a speciality when they gain level 1 in a skill that has two or more specialities.
...
* Quando tentar lembrar algum trivia ou pedaço de conhecimento comum, um Viajante usa seu Modificador de Dado EDU.
* Quando tentar impressionar um guarda com sua riqueza ou posição, um Viajante usa seu Modificador de Dado SOC.

## VERIFICAÇÕES DE HABILIDADE

Para uma verificação de habilidade, o Viajante soma seu nível de habilidade e, se apropriado, um modificador de Característica (DM). A combinação de habilidade e característica varia dependendo da situação, conforme escolhido pelo árbitro:

* Atirar com uma arma usaria a habilidade de Combate com Arma apropriada e o Modificador de Dado DEX do Viajante.
* Reparar uma arma danificada pode usar Combate com Arma e EDU.
* Tentar descobrir que tipo de arma causou um ferimento particular pode usar Combate com Arma e INT (ou talvez Investigar e INT).
* Esconder-se de um soldado inimigo exigiria um teste de Furtividade e DEX, enquanto ficar parado por muito tempo para evitar a detecção seria um teste de Furtividade mais um teste de FIM.
* Simplesmente festejar em um bar pode usar Carouse por si só, sem qualquer característica particular. Se o Viajante quiser vencer...

alguém em um concurso de bebida, eles podem usar Carouse e END; espiar quem está fora de lugar em uma festa pode ser Carouse e SOC, e bajular alguém pode usar Carouse e SOC.

Se um Viajante não tiver níveis em uma habilidade usada em uma verificação, ele sofre DM-3 na verificação por ser inexperiente.

Para resumir;

Para fazer uma verificação de habilidade normal (Média), um Viajante rola 2D + Nível de Habilidade + Característica DM + qualquer outro DM relevante e deve obter um total de 8 ou mais para ser bem-sucedido.

Por exemplo, Kathya (DEX 10, Furtividade 0), Erik (DEX 6, Furtividade 2) e Morn (DEX 12, sem Furtividade) estão todos tentando se esgueirar por um corredor. Kathya tem DEX DM+1 e enquanto ela não sofre DM por ser inexperiente, tendo apenas Furtividade 0. Seu modificador final é DM+1; ela rola 2D+1 e tenta obter 8 ou mais. Erik tem DEX DM+0, mas tem Furtividade 2. Seu modificador final é DM+2; ele rola 2D+2 e tenta obter 8 ou mais. Morn é mais desajeitado do que qualquer um de seus companheiros, com seu DEX DM+2. No entanto, ele não tem habilidade de Furtividade e sofre DM-3 por ser inexperiente. Seu modificador final é DM-1, então ele rola 2D-1 e tenta obter 8 ou mais.

<div style="text-align: right;">SKILLS AND TASKS</div>
...
Simple tasks are trivial for everyone. A Simple task might be requesting weather data from a standard tourist computer system, ordering a meal in a language you know well or sneaking up on a drugged guard. Simple tasks require a 2 or more to be rolled for the check if, indeed, they are rolled at all.

---

## Task Difficulty

These difficulties are summarised on the Task Difficulty table.
...
For example, Erik (INT 9, Carouse 1) is trying to find information about a mysterious ship that landed at the starport. He goes to a bar frequented by wanderers and spacers, hoping to pick up a rumour. This is a Carouse check and the referee says that it is a Difficult (10+) task. Erik has one level of Carouse, which grants him DM+1, an INT of 9 (for an additional DM+1), giving him a final of DM+2. He rolls 2D+2 and tries to get 10 or more.

Note that if no difficulty is listed for a check, you can always assume it is Average (8+).

## BOON AND BANE

The task difficulty levels allow a referee to pre-plan the skill and characteristic checks Travellers will need to succeed during an adventure. However, there will likely be situations that arise that will make things either easier or harder for the Travellers. This is where Boons and Banes come in.
...
## TIMEFRAMES
Each task has a random timeframe of one to six time units. The unit depends on the task – shooting someone or throwing a punch takes 1D seconds, while prepping an air/raft for flight might take 1D minutes, looking for rumours on the street might take 1D hours and repairing a damaged component on a ship might take 1D x 10 hours.
...
For example, Kathya is trying to fix a damaged jump engine in the middle of a battle. Repairing the engine would normally take 1D hours but an enemy ship is closing fast and they need to jump as soon as possible. Kathya therefore decides to increase the difficulty and suffer a DM-2 to her check in order to reduce the time by one step. Instead of 1D hours, it will only take 1D x 10 minutes. She rolls a 3 for the timeframe, so it takes her 30 minutes to repair the engines.
...
For example, Erik and Kathya are trying to locate a hidden base on an icy moon. Erik has Electronics (computers) and suggests trying to augment their ship’s scanners. Kathya has the Electronics (sensors) skill and stays on the bridge while Erik goes down to the sensor pods with his toolkit.

Firstly, Erik makes his Electronics (computers) check. He gets Effect 5, which grants DM+2 to the next task in the chain. Kathya will now make her Electronics (sensors) check with DM+2 thanks to Erik’s efforts.
...
*   **Instrument**: Playing a particular musical instrument, such as a flute, piano or organ.
...
### Specialities
*   **Dexterity**: Climbing, Juggling, Throwing. For alien species with wings, this also includes flying.
...
### Specialities
* **Comms:** The use of modern telecommunications; opening communications channels, querying computer networks, jamming signals and so on, as well as the proper protocols for communicating with starports and other spacecraft.
...
* **Remote Ops:** Using telepresence to remotely control drones, missiles, robots and other devices.
*Using a Mining Drone to Excavate an Asteroid: Routine (6+) Electronics (remote ops) check (1D hours, DEX).*

* **Sensors:** The use and interpretation of data from electronic sensor devices, from observation satellites and remote probes to thermal imaging and densitometers.
...
*Overcharging a Thruster Plate to Increase a Ship’s Agility: Difficult (10+) Engineer (m-drive) check (1D minutes, INT).*
*Estimating a Ship’s Tonnage From its Observed Performance: Average (8+) Engineer (m-drive) check (1D x 10 seconds, INT).*
...
# Heavy Weapons
The Heavy Weapons skill covers portable and larger weapons that cause extreme property damage, such as rocket launchers, artillery and large plasma weapons.
...
# Jack-of-All-Trades
The Jack-of-All-Trades skill works differently to other skills. It reduces the unskilled penalty a Traveller receives for not having the appropriate skill by one for every level of Jack-of-All-Trades. For example, if a Traveller does not have the Pilot skill, they suffer DM-3 to all Pilot checks. If that Traveller has Jack-of-All-Trades 2, then the penalty is reduced by 2 to DM-1. With Jack-of-All-Trades 3, a Traveller can totally negate the penalty for being unskilled.
...
# Leadership
The Leadership skill is for directing, inspiring and rallying allies and comrades. A Traveller may make a Leadership action in combat, as detailed on page 74.
...
# Medic
The Medic skill covers emergency first aid and battlefield triage as well as diagnosis, treatment, surgery and long-term care. See *Injury and Recovery* on page 82.
...
The Pilot skill specialities cover different forms of spacecraft. See the Spacecraft Operations chapter for more details.
...
![Illustration of three travellers in vacc suits exploring a misty, alien landscape with strange flora and structures in the background.](image_placeholder)
...
> *   Perform any number of Free Actions (although the referee is free to impose a limit according to circumstances).
...
### MISCELLANEOUS
A Traveller may make a skill check or do something else as a Significant Action when it requires their full attention, concentration, complicated physical or mental actions, or a combination thereof. These include the following:
...
### MISCELLANEOUS
A Traveller may make a skill check or do something else as a Minor Action if it does not require their full attention, concentration, complicated physical or mental actions. These include the following:
...
## MELEE ATTACKS
When a Traveller is within two metres of an enemy, they are said to be locked in close combat. At this very short range, certain rules apply.
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Dagger | 1 | Melee | 1D+2 | 0.2 | Cr10 | — | — | — |
| Rifle | 5 | 500 m | 3D | 3 | Cr200 | 20 | 10 | — |
...
Armour reduces the damage sustained in an attack by the value of its Protection score. An attack with Effect 6+ always inflicts at least one point of damage, regardless of the actual damage rolled or the Protection score.

Some weapons have the AP, or Armour Piercing, trait. These weapons ignore an amount of Armour equal to their AP score.

## COVER

When the bullets start flying, Travellers are advised to take cover behind something solid, ducking back when shot at and popping up to return fire.
...
If a Traveller is able to position themselves completely in cover so the enemy cannot see them, and chooses not to make any attacks, they can hide.

However, if an enemy is aware of the Traveller’s presence, they can still be attacked. The Traveller gains all the benefits of cover but also gains a bonus to their armour’s Protection (or giving the Traveller Protection if they did not already have one). The amount of bonus Protection a target receives depends on the type of cover it is hiding behind.
...
*   Inflict damage equal to 2 + the Effect of the Melee check. This damage ignores any armour.
...
**Smart:** This weapon has intelligent or semi-intelligent rounds able to guide themselves to a target. They gain a DM to their attack rolls equal to the difference between their TL and that of the target (usually their armour or vehicle, although Smart weapons can also home in on communications devices, computers and weapons). This DM will be a minimum of DM+1 and a maximum of DM+6.
...
A Traveller who falls on a 1-gravity world suffers 1D damage for every two metres they fall. High- or low-gravity worlds will increase or decrease the damage by 1D for every four metres fallen. A Traveller who make a successful Athletics check
...
o uso de trajes pressurizados ou motorizados para apoiar a estrutura humana. Viajantes em mundos de alta gravidade sofrem DM-1 em todas as verificações de habilidade até se aclimatar, um processo que leva 1D semanas. Viajantes com a habilidade Atletismo (força) se aclimatarão em 1D dias.

**Baixa Gravidade:** Ambientes que têm uma gravidade de 0.7 G ou menos (tipicamente mundos de Tamanho 6 ou menores) são classificados como Baixa Gravidade. Os humanos tendem a achar a vida em mundos de baixa gravidade inicialmente agradável, mas regimes regulares de exercícios e suplementos medicinais são necessários para prevenir a perda óssea e a degradação muscular. Aqueles que passam muito tempo em mundos de baixa gravidade não toleram gravidades mais altas. Viajantes em mundos de baixa gravidade sofrem DM-1 em todas as verificações de habilidade física até se aclimatar, um processo que leva 1D semanas. Viajantes com a habilidade Atletismo (destreza) se aclimatarão em 1D dias.

**Gravidade Zero:** Um Viajante em uma situação de gravidade zero sofre todos os efeitos da Baixa Gravidade (o Tamanho do mundo é assumido como 0). Além disso, eles devem ter cuidado com coisas que podem afetar seu momento – mais notavelmente, armas de fogo que têm recuo.

Toda vez que um Viajante usa uma arma de combate corpo a corpo ou qualquer arma de longo alcance que não tenha o traço Zero-G, eles devem fazer uma verificação de Atletismo (destreza) Média (8+) ou não apenas errarão seu alvo, mas começarão a girar sem controle.

Um Viajante girando fora de controle em gravidade zero pode recuperar o controle com uma verificação de Atletismo (destreza) Média (8+).

# RADIAÇÃO

A Radiação é um perigo constante no espaço. Os materiais do casco da nave espacial blindam contra a maior parte da radiação; juntamente com a proteção adicional oferecida por tanques de combustível que revestem o casco interno, isso significa que a exposição sofrida pela maioria dos espaçadores é apenas algumas vezes maior do que a exposição ao estar em um planeta. Viajantes em naves voando muito perto de uma estrela ou com cascos violados ou reatores danificados correm risco e a presença de radiação nociva em mundos ou em combate significa que os Viajantes devem ficar atentos quando saem de suas naves.

A exposição à radiação é medida em rads. Uma vez que um Viajante absorveu um certo número de rads, eles sofrerão os efeitos da radiação. Um problema com a exposição à radiação é que, embora os sintomas físicos possam ser tratados e a cura possa ocorrer, os efeitos cumulativos da radiação em si nunca desaparecem. Os rads do Viajante devem ser rastreados e qualquer exposição adicional adiciona ao que o Viajante já está sofrendo em um nível de perigo mortal. Os rads acumulados só podem ser removidos usando drogas anti-radiação.

Os efeitos da radiação são sofridos cada vez que um Viajante é exposto à radiação, e como resultado de rads cumulativos ao longo do tempo. Assim, um Viajante que absorveu 75 rads no passado e subsequentemente se recuperou dos efeitos, quem então absorve mais 20 rads de um clarão solar, agora tem um total de 95 rads, quer sofram quaisquer efeitos sérios desta vez ou não. Eles estão se aproximando de uma dose moderada, como mostrado na tabela Efeitos da Radiação.

Viajantes expostos a uma arma com o traço Radiação receberão uma dose única de radiação. Entrar em uma área radioativa ou ser exposto a um vazamento ou clarão solar causará exposição a cada poucos minutos ou horas.

## Exposição à Radiação

| Fonte de Radiação | Rads Recebidos |
| :--- | :--- |
| Vazamento de reator menor | 2D/hora |
| Vazamento de reator sério | 2D/20 minutos |
| Clarão solar menor | 1D x 100/hora |
| Clarão solar maior | 3D x 100/hora |
| Arma de radiação | 2D x 20 imediatamente |

Ternos de vácuo e outras medidas de proteção reduzem a exposição à radiação, como mostrado na página 102. O casco de uma nave espacial diminui a exposição à radiação daqueles dentro em 500.

## Efeitos da Radiação

### Exposição Imediata à Radiação

| Exposição | Efeitos Imediatos |
| :--- | :--- |
| 50 rads ou menos | Nenhum |
| 51–150 rads | 1D de dano, Náusea (-1 em todas as verificações até tratamento médico recebido) |
| 151–300 rads | 2D de dano |
| 301–500 rads | 4D de dano, perda de cabelo |
| 501–800 rads | 6D de dano, estéril |
| 801 rads ou mais | 8D de dano, hemorragia interna |

### Exposição Cumulativa à Radiação

| Exposição Cumulativa | Efeitos Cumulativos |
| :--- | :--- |
| 50 rads ou menos | Nenhum |
| 51–150 rads | Nenhum |
| 151–300 rads | -1 END permanentemente |
| 301–500 rads | -2 END permanentemente |
| 501–800 rads | -3 END permanentemente |
| 801 rads ou mais | -4 END permanentemente |
...
| Burning Torch | 1D/round | Industrial Freezer | 1D/round |
...
| :--- | :--- | :--- |
| **Larker** | 100 | 9m |
| **Skills** | Athletics (endurance) 2, Athletics (strength) 4, Survival 2 | |
| **Attacks** | Charge (5D) | |
| **Traits** | Armour (+12), Large (+4) | |
...
| Crowded Area | DM-2 |
| In Space | DM+4 |
| Target is a Vehicle | DM+2 for every 10 tons of Shipping or part of |
...
**Hits:** How much damage the animal can sustain before it is killed. All damage is applied to Hits, rather than STR, DEX and END as for Travellers. When an animal's Hits are reduced to zero, it is dead. Optionally, animals are knocked unconscious when reduced to 10% or less of their Hits. A Stun weapon will incapacitate an animal if it inflicts a cumulative amount of damage equal to half of its Hits.
...
**Armour (+X):** The animal has dense layers of fat, horny plates or some other form of physical protection. It has a Protection score equal to the figure shown in the Armour trait.
...
| :--- | :--- | :--- |
| Carthus | 28 | 13m |
| **Skills** | Melee (natural) 3, Recon 2, Stealth 2, Survival 2 |
| **Attacks** | Bite (4D) |
| **Traits** | Amphibious, Camouflaged, Fast Metabolism (+2), Heightened Senses, Large (+1) |
...
| :--- | :--- | :--- |
| Erakruul | 95 | 5m |
| **Skills** | Athletics (strength) 3, Survival 3 |
| **Attacks** | Bite (6D) |
| **Traits** | Bioelectricity (+4D), Heightened Senses, Large (+5), Slow Metabolism (-3) |
...
| :--- | :--- | :--- |
| Gazaal | 36 | 6m |
| **Skills** | Athletics (endurance)+2, Recon 0, Survival 2 | |
| **Attacks** | Horns (2D), Trample (3D) | |
| **Traits** | Armour (+2), Heightened Senses, Large (+2) | |
| **Behaviour** | Herbivore, Grazer | |
...
| Animal | Hits | Speed |
| :--- | :--- | :--- |
| Klian Sea Sifter | 6 | 2m |
| **Skills** | Recon 1, Stealth 0, Survival 1 | |
| **Attacks** | Claws (D3) | |
| **Traits** | Amphibious, Armour (+4), Camouflage, Small (-2) | |
| **Behaviour** | Carnivore, Grazer | |
...
| :--- | :--- | :--- |
| Nibbon | 3 | 10m |
| **Skills** | Athletics (dexterity) 3, Recon 3, Stealth 2, Survival 2 | |
| **Attacks** | Claws (D3) | |
| **Traits** | Flyer (slow), Heightened Senses, Poison (Difficult/2D/1D hours) | |
| **Behaviour** | Omnivore, Hunter | |

## Ruuta

The ruuta is a small ball covered in mottled down. There are no apparent eyes or other features apart from webbed spines protruding from each side of its sphere, like wings, which flap at incredible speed and make a deep buzzing noise as it spends the majority of its life in the upper clouds of its homeworld feeding on chemicals by absorption through its wing membranes and only returns to the surface to lay eggs. The males of this species are approximately four centimetres in diameter and tend to be vibrantly coloured in order to attract mates while the females are around eight centimetres in diameter and tend to be mostly black, white and varying shades of grey.

| Animal | Hits | Speed |
| :--- | :--- | :--- |
| Ruuta | 1 | 0m |
| **Skills** | Athletics (dexterity) 2, Recon 3, Survival 0 | |
| **Attacks** | None | |
| **Traits** | Fast Metabolism (+3), Flyer (slow), Heightened Senses, IR/UV Vision, Small (-4) | |
| **Behaviour** | Scavenger, Filter | |

---

# HOW BIG A BEAST?

When creating a new animal for an encounter, a referee simply has to decide on a concept for the creature, assign an appropriate amount of Hits and attacks, and then record any desired skills, Traits and Behaviour.
...
### Quick Characters
If a referee needs to quickly create a Contact, Ally, Rival or Enemy, or if a Traveller needs inspiration to create one, you can roll on the Allies and Enemies table. If desired, also roll on the Character Quirks table to give the character an added dimension.
...
| 15 | Will betray characters | 45 | Mistakes a Traveller for someone else |
| 16 | Aggressive | 46 | Possesses unusually advanced technology |
| 21 | Has secret allies | 51 | Unusually handsome or beautiful |
| 22 | Secret anagathic user | 52 | Spying on the Travellers |
| 23 | Looking for something | 53 | Possesses TAS membership |
| 24 | Helpful | 54 | Is secretly hostile towards the Travellers |
| 25 | Forgetful | 55 | Wants to borrow money |
| 26 | Wants to hire the Travellers | 56 | Is convinced the Travellers are dangerous |
| 31 | Has useful contacts | 61 | Involved in political intrigue |
| 32 | Artistic | 62 | Has a dangerous secret |
| 33 | Easily confused | 63 | Wants to get off planet as soon as possible |
| 34 | Unusually ugly | 64 | Attracted to a Traveller |
| 35 | Worried about current situation | 65 | From offworld |
| 36 | Shows pictures of their children | 66 | Possesses telepathy or other unusual quality |
...
| 36 | Transport dangerous goods | 66 | It is a trap – the Patron intends to betray the Traveller |

#### Random Targets
| D66 | Target | D66 | Target |
|-----|--------|-----|--------|
| 11 | Common Trade Goods | 41 | Roll on the Random Patron table |
| 12 | Common Trade Goods | 42 | Roll on the Random Patron table |
| 13 | Random Trade Goods | 43 | Roll on the Random Patron table |
| 14 | Random Trade Goods | 44 | Roll on the Allies and Enemies table |
| 15 | Illegal Trade Goods | 45 | Roll on the Allies and Enemies table |
| 16 | Illegal Trade Goods | 46 | Roll on the Allies and Enemies table |
...
| 16 | Local merchant with cargo to transport seeks a ship | 46 | Old crippled belter asks for spare change and complains about drones taking their job |
...
| 26 | Attempted robbery of Travellers | 56 | Street preacher rants at the Travellers |
...
You should note that items are available for several Tech Levels after they first appear but it is often quite hard to find a low-tech item on a high-tech world (few TL13 spacefaring civilisations are going to produce a lot of crossbows or backpack radios).
...
|--------------------|------------|--------------|
| Very Poor | Cr400 | SOC 2 |
| Poor | Cr800 | SOC 4 |
| Low | Cr1000 | SOC 5 |
| Average | Cr1200 | SOC 6 |
| Good | Cr1500 | SOC 7 |
| High | Cr2000 | SOC 8 |
| Very High | Cr2500 | SOC 10 |
| Rich | Cr5000 | SOC 12 |
| Very Rich | Cr12000 | SOC 14 |
| Ludicrously Rich | Cr20000+ | SOC 15 |

### Encumbrance
Under most circumstances, the referee can simply rule that Travellers can carry a 'reasonable' amount of equipment without actually tracking it – armour, a main weapon, a pistol, a few grenades and items in a backpack are all reasonable.
...
Most items of equipment have a listed Mass and a referee can also use this to limit what is being carried. A Traveller should be able to carry equipment totalling a number of kilograms equal to their combined STR and END without penalty, plus any levels in Athletics (strength and/or endurance).
...
The mass of armour is distributed around the body when worn properly, thus reducing its effective weight. You can reduce the mass of armour that is being worn by 75% for the purposes of encumbrance.

### Armour
Unless otherwise noted, only one type of armour can be worn at a time but there are exceptions. Resolve damage from the outside in – damage that gets through the outer layer of armour is next applied to the inner layer.
...
Radiation is a very present danger to many Travellers, whether in combat or exploration. Some armour provides a measure of defence against radiation, as noted in the Rad column of the armour table. This amount is deducted from the rads a Traveller receives every time they are exposed to radiation.
...
| Cloth | +8 | 10 | — | 3 | Cr500 | None |
| Flak Jacket | +3 | 7 | — | 8 | Cr100 | None |
| Flak Jacket | +5 | 8 | — | 6 | Cr300 | None |
| Reflec | +10 (vs. lasers only) | 10 | — | 1 | Cr1500 | None |
| Ablat | +1 (+6 vs. lasers only) | 9 | — | 2 | Cr75 | None |
| Combat Armour | +13 | 10 | 85 | 20 | Cr96000 | Vacc Suit 1 |
| Combat Armour | +17 | 12 | 145 | 16 | Cr88000 | Vacc Suit 0 |
| Combat Armour | +19 | 14 | 180 | 12 | Cr160000 | Vacc Suit 0 |
| Vacc Suit | +4 | 8 | 15 | 28 | Cr12000 | Vacc Suit 1 |
| Vacc Suit | +8 | 10 | 60 | 12 | Cr10000 | Vacc Suit 0 |
| Vacc Suit | +10 | 12 | 90 | 8 | Cr20000 | Vacc Suit 0 |
| Hostile Environment Vacc Suit | +8 | 9 | 75 | 40 | Cr24000 | Vacc Suit 1 |
| Hostile Environment Vacc Suit | +9 | 10 | 90 | 30 | Cr20000 | Vacc Suit 1 |
| Hostile Environment Vacc Suit | +14 | 13 | 170 | 20 | Cr40000 | Vacc Suit 0 |
| Hostile Environment Vacc Suit | +15 | 14 | 185 | 10 | Cr60000 | Vacc Suit 0 |
| Battle Dress | +22 | 13 | 245 | 100\* | Cr200000 | Vacc Suit 2 |
| Battle Dress | +25 | 14 | 290 | 100\* | Cr220000 | Vacc Suit 1 |

\*As a powered armour, battle dress supports its own weight. While powered and active, the mass of battle dress does not count against the encumbrance of the wearer and is effectively weightless.

#### Armour Descriptions
**Ablat:** A cheap alternative to reflec, ablat armour is made from a material that ablates (vaporises) when hit by laser fire. Each laser hit on ablat armour reduces its Protection value against lasers by one but the armour is cheap and easily replaceable.

**Battle Dress:** The premier personal armour, battle dress is a powered form of combat armour but much tougher. The servomotors vastly increase the user's speed and strength, increasing STR and DEX by +4 while wearing the armour. Damage to the wearer's characteristics is calculated as normal but the bonus values from the armour are used for all other purposes such as melee damage or skill checks. An on-board Computer/2 gives tactical advice and updates, and the suit is commonly outfitted with numerous upgrades.

The suit is fully enclosed, with a six-hour air supply and gives substantial protection against NBC (nuclear/biological/chemical) hazards. All weapons used while wearing battle dress count as having the Scope trait.

TL14: This more advanced battle dress is considerably stronger, granting STR+6 and upgrades the internal systems to Computer/3.

**Cloth:** A heavy duty body suit tailored from ballistic cloth. The fabric absorbs impact energy and spreads it over the body, which can result in bruising. However, cloth armour is highly useful and versatile.

TL10: This armour is lighter and more flexible, and can be indistinguishable from ordinary clothing under normal circumstances.

**Combat Armour:** This full-body suit is used by the military and not generally available on the open market, although those with military or criminal contacts can obtain suits. It is issued to troop units and mercenary battalions. Combat armour can function as a vacc suit and provides life support for six hours. All weapons used while wearing combat armour count as having the Scope trait.

TL12: Considerably lighter, substituting carbon-tube weave for the smart plastic of the previous generation.
...
**Reflec:** Reflec armour is a flexible plastic suit with layers of reflective material and heat-dispersing gel. It is highly effective against lasers but provides no protection against other attacks. Reflec can be worn with other armour but is hard to obtain, quite expensive and imposes DM-2 on any Stealth checks the wearer attempts.

**Vacc Suit:** The vacc suit or space suit is the spacer's best friend, providing life support and protection when in space. Early vacc suits are unwieldy and uncomfortable but quickly shrink as technology advances. A vacc suit provides life support for six hours.

TL10: An improved version that masses a lot less.

TL12: At this Tech Level, 'tailored' vacc suits feel like ordinary clothing with a flexible hood and face mask.
...
**Chameleon, Vislight (TL13):** A more advanced form of IR chameleon, vislight chameleon layers the surface of the armour with light-bending technology, making the wearer nearly invisible to the naked eye (DM-4 to spot). Vislight chameleon costs Cr50000.

**Computer Weave (TL10):** Computer weave can be added to any armour that does not already have a computer system and adds a Computer/0 to that armour. Costs Cr500.

TL11: Improved computer weave adds Computer/1. Costs Cr1000.

TL13: Advanced computer weave adds Computer/2. Costs Cr5000.

**Extended Life Support (TL10):** This upgrade can be added to any suit that provides life support (vacc suit, HEV suit, combat armour, battle dress). By adding high-pressure oxygen tanks and recycling systems, the suit now provides 18 hours of oxygen. Costs Cr10000.

**Eye Protection (TL6):** A lot of armour includes eye protection such as visors or goggles to guard against flying debris but such protection becomes absolutely vital at TL9 to guard against the blinding effects of lasers. Eye protection can be added to any armour but is automatically included in any TL9+ armour. Costs Cr50.

**Grav Assist (TL12):** This upgrade can be added to combat armour or battle dress only and adds the functionality of a grav belt (see page 119) to the armour at the cost of Cr110000.

TL15: The TL15 version lasts longer. Costs Cr120000.
...
**Medikit (TL10):** An internal medical scanner and drug injector, the medikit can be installed in combat armour, battle dress or a vacc suit. It automatically applies first aid if the Traveller is reduced to END 0 (treat as having Medic 3). It can also administer Fast Drug on command or if life support systems are failing. Costs Cr5000.

TL11: A military medikit can also inject combat drugs and metabolic accelerators on command. Costs Cr10000.

**Self-Sealing (TL11):** Self-sealing systems can be added to any armour (except ablat) when it is being made. The armour can seal breaches and repair minor damage. This cannot reconstruct a severely damaged suit of armour but does ensure that a ripped vacc suit or torn jacket repairs itself. Self-sealing only repairs minor damage – getting shot or stabbed is about the limit of the self-sealing capability to manage. Self-sealing costs Cr2000.
...
**Thruster Pack (TL9):** A simple thruster pack gives the user the ability to manoeuvre in zero-gravity over short distances. An Athletics (dexterity) check is required to use it accurately. Thruster packs can only be used in microgravity environments. A thruster pack costs Cr2000.

TL12: The long-range thruster pack gives 0.1G acceleration for up to 48 hours, using standard starship fuel. This costs Cr14000.

TL14: The TL14 version of the long-range pack is much smaller, as it uses grav-thruster plates instead but has the same performance profile as the TL12 version. This costs Cr20000.
...
| Subdermal Armour | Protection+1 | 10 | Cr50000 |
| Subdermal Armour | Protection+3 | 11 | Cr100000 |
...
**Subdermal Armour:** Adds a mesh of ballistic fibres to the skin and reinforces the bones, giving the Traveller extra armour. Subdermal armour stacks with other protection.
...
| | TL5 | 20kg | 5km | Cr225 |
| | TL5 | 70kg | 50km | Cr750 |
| | TL5 | 150kg | 500m | Cr1500 |
| | TL5 | 300kg | 5,000km | Cr15000 |
| | TL8 | — | 50km | Cr75 |
| | TL9 | — | 500km | Cr500 |
| | TL9 (Computer/0) | — | 2,500km | Cr5000 |
| | TL10 (Computer/0) | — | 500km | Cr250 |
| | TL12 (Computer/0) | 1kg | 10,000km | Cr1000 |
| | TL13 (Computer/1) | — | 1,000km | Cr250 |
| | TL14 (Computer/1) | — | 3,000km | Cr500 |

#### Laser Transceivers
| | TL | MASS | RANGE | COST |
|---|----|------|-------|------|
| | TL9 (Computer/0) | 1.5kg | 500km | Cr2500 |
| | TL11 (Computer/0) | 0.5kg | 500km | Cr1500 |
| | TL13 (Computer/1) | — | 500km | Cr500 |
...
| TL15 Passive bug | Audio/Visual/Data/Bioscan/Computer/1 | Cr500 |

Audio: The bug records anything it hears.
Visual: The bug records anything it sees.
Data: If attached to a computer system, the bug can search and copy data from the computer. The bug cannot breach computer security on its own but if a user accesses the computer in the bug's presence, the bug can read their data.
...
A bug can be active or passive. An active bug transmits data (either constantly, or when triggered) while a passive bug just records until collected.
...
**Transceiver:** A transceiver is a stand-alone communications device, what today we would call a two-way radio. Unlike a mobile comm, which relies on the presence of an established communications network, a transceiver can send and receive directly under its own power. Most transceivers are radio or laser-based. Meson communicators are possible but generally not easily portable or available.

To reach orbital ranges reliably, a transceiver requires a range of 500 kilometres.

### Computers & Software
Computers in Traveller are ranked by their Processing score. A Computer/3, for example, has a Processing score of 3. This is its ability to run software.
...
| Security | 1 | TL10 | Cr200 | Difficult (10+) difficulty. |
| Security | 2 | TL11 | Cr1000 | Very Difficult (12+) difficulty. |
| Security | 3 | TL12 | Cr20000 | Formidable (14+) difficulty. |
...
| Intrusion | 2 | TL11 | Cr10000 | |
| Intrusion | 3 | TL13 | Cr100000 | |
| Intrusion | 4 | TL15 | MCr1 | |
| Expert | 1 | TL11 | Cr1000 | Expert software packages mimic skills. A Traveller using Expert may make a skill check as if they had the skill at the software's Bandwidth-1. Only INT and EDU-based checks can be attempted. If a Traveller already has the skill, then Expert grants DM+1 to their check. |
| Expert | 2 | TL12 | Cr10000 | |
| Expert | 3 | TL13 | Cr100000 | |
| Translator | 0 | TL9 | Cr50 | Translators are specialised Expert packages that only have Language skills. The TL9 version provides a near-real-time translation. |
| Translator | 1 | TL10 | Cr500 | The TL10 works in real-time and has a much better understanding of the nuances of language. |
| Database | — | TL7 | Cr10-10000 | A database is a large store of information on a topic that can be searched with an Electronics (computers) check or using an Agent. |
| Agent | 0 | TL11 | Cr500 | Agent packages have an Electronics (computers) skill equal to their Bandwidth and can carry out tasks assigned to them with a modicum of intelligence. |
| Agent | 1 | TL12 | Cr2000 | |
| Agent | 2 | TL13 | Cr100000 | |
| Agent | 3 | TL14 | Cr250000 | |
| Intellect | 1 | TL12 | Cr2000 | Intellect is an improved Agent, which can use Expert systems. |
| Intellect | 2 | TL13 | Cr50000 | |
| Intellect | 3 | TL14 | Cr200000 | |
...
|----|------------|------|------|
| TL7 | Computer/0 | 5kg | Cr500 |
| TL8 | Computer/1 | 2kg | Cr250 |
| TL9 | Computer/1 | 1kg | Cr100 |
| TL10 | Computer/2 | 0.5kg | Cr500 |
| TL11 | Computer/2 | 0.5kg | Cr300 |
| TL12 | Computer/3 | 0.5kg | Cr1000 |
| TL13 | Computer/4 | 0.5kg | Cr1500 |
| TL14 | Computer/5 | 0.5kg | Cr5000 |

#### Options
**Comms (TL8+):** Any computer of TL8 or more can act as a short-ranged comm unit or transceiver if specified at purchase. This does not increase the cost of the computer.
...
**Medikit (TL8+):** There are different types of medikit available at different Tech Levels. All medikits contain diagnostic devices and scanners, surgical tools and a panoply of drugs and antibiotics, allowing a medic to practise their art in the field. Advanced medikits can help with more exotic problems or when treating augmented individuals. For example, a TL8 medikit can test blood pressure and temperature, while a TL14 kit has a medical densitometer to create a three-dimensional view of the patient's body and can scan brain activity on the quantum level. All medikits mass 1kg, except at TL14 where they have an effective mass of 0kg.
...
|--------|----|----|------|
| Binoculars | 3 | 1 | Cr75 |
| Binoculars | 8 | 1 | Cr750 |
| Binoculars | 12 | 1 | Cr3500 |
| Bioscanner | 15 | 3.5 | Cr350000 |
| Densitometer | 14 | 5 | Cr20000 |
| EM Probe | 10 | 1 | Cr1000 |
| Geiger Counter | 5 | 2 | Cr250 |
| Geiger Counter | 10 | — | Cr150 |
| IR Goggles | 6 | — | Cr500 |
| Light Intensifier Goggles | 7 | 1 | Cr500 |
| Light Intensifier Goggles | 9 | — | Cr1250 |
| NAS | 15 | 10 | Cr350000 |

**Binoculars:** Allow the user to see further.
TL8: Electronic enhancement allows images to be captured; light-intensification allows them to be used in the dark.
TL12: PRIS (Portable Radiation Imaging System) allows the user to observe a large section of the EM-spectrum, from infrared to gamma rays.
...
**IR Goggles:** Permits the user to see exothermic (heat-emitting) sources in the dark.

**Light Intensifier Goggles:** Permits the users to see normally in anything less than total darkness by electronically intensifying any available light.
...
On worlds and places hostile to human life, Travellers must use environmental suits to protect themselves. If colonies are established on such worlds, then the Imperium usually begins a terraforming process to transform the planet and make it more Earth-like. Terraforming takes decades, even millennia, and is a ferociously expensive and intensive process. Sometimes, it might be easier to remake the colonists to fit the world using genetic engineering and surgery. See also Vacc Suits on page 102.
...
| Habitat Module | 8 | 1,000 | Cr10000 |
...
**Breather Mask:** Combines filter and respirator into a single package.
TL10: The more advanced filter is small enough to fit into the nose or can even be a lung implant.

**Climbing Kit:** A set of accessories designed to make climbing easier. Includes a safety harness, gloves and rock shoes, belt with secure holders for tools and head protection. The kit provides DM+1 to attempts to climb rock surfaces.
TL8: The kit includes a lightweight harness suitable for abseiling or rappelling, expanding mini-pitons for small rock crevices and more advanced versions of the accessories in the basic kit, providing DM+2 to attempts to climb rock surfaces.
...
**Habitat Module:** A modular unpressurised quarters for six people, capable of withstanding anything less than hurricane-force winds. Includes survival rations and battery power to last a week. Requires 12 man-hours to assemble and can be attached to other modules to form a base.
TL10: The TL10 module is pressurised and includes life-support for six occupants for one week (1,000 person/hours).
...
**Respirator:** This rebreather concentrates inhaled oxygen, allowing a Traveller to breathe on worlds with a thin atmosphere. Respirators take the form of a face mask or mouthpiece initially.
TL10: The more advanced respirator is small enough to fit into the nose or can even be a lung implant.

**Tent:** A basic tent provides shelter for two people against the weather.
TL7: The TL7 version can be pressurised. There is no airlock – the tent is depressurised when opened.
...
### Toolkits
Technical skills require specialist tools of various kinds. These kits contain diagnostic sensors, hand tools, computer analysis programs and spare parts.
...
| TOOLKITS | TL | KG | COST |
|----------|----|----|------|
| Electronics | 7 | 2 | Cr2000 |
| Engineering | 12 | 12 | Cr4000 |
| Forensics | 8 | 12 | Cr2000 |
| Mechanical | 5 | 12 | Cr1000 |
| Scientific | 5 | 8 | Cr2000 |
| Surveying | 6 | 12 | Cr1000 |
...
**Life Sciences Toolkit:** The life science toolkit contains tools to aid the performance of tasks with the Science specialities of biology, genetics and xenology. It contains biological sampling equipment, optical and electronic microscopes, chemical analysis equipment and sequencers for DNA, proteins and other common life-related molecules. In addition, the toolkit can also aid in medical diagnosis, providing a DM+1 to Medic or Investigate checks to diagnose a medical condition.
...
**Social Science Expert Packages:** Social sciences do not generally require tools but access to methodologies, data collection algorithms and large libraries of information, both qualitative and quantitative. Social science expert packages are installed on specialised dedicated computer tablets running Intellect and Expert software in the speciality. These computers contain extensive databases and analysis engines for social science specialities and provide DM+2 to checks in the speciality. Travellers unskilled in the Science speciality of the Expert system may interact with the computer to understand or complete tasks of up to Very Difficult (12+) complexity with effective skill level 1 in the system's speciality. Specific library packages apply to the economics, history, linguistics, philosophy, psychology and sophontology specialities. More obscure packages for esoteric social science specialities may also exist, but may be difficult to locate, expensive, or of questionable reliability.

| Item | TL | Kg | Cost |
|------|----|----|------|
| Science Toolkit | 12 | 8 | Cr2000 |
| Science Expert Package | 12 | 1 | Cr2000 |

### Melee Weapons
With the advent of powered armour and portable fusion generators, the line between personal weapon and heavy artillery is blurred. The high-end weapons available in the Imperium are staggeringly powerful. Few private citizens can obtain such weapons legally but small brush wars can turn into alarming plasma-fired conflagrations when mercenaries are involved.
...
| Rapier | 3 | Melee | 2D | 0.5 | Cr200 | — | — | — |
| Shield | 1 | Melee | 1D | 2 | Cr150 | — | — | — |
| Staff | 1 | Melee | 2D | 2 | — | — | — | — |
...
**Club:** The first weapon emerging civilisations usually discover. Clubs can range from a length of heavy wood to extending riot batons of advanced polymers but they remain a popular and practical weapon regardless.
...
|--------|----|-------|--------|----|------|----------|---------------|--------|
| **PISTOLS** | | | | | | | | |
| Antique Pistol | 2 | 5m | 2D-3 | 0.5 | Cr100 | 1 | Cr5 | — |
| Autopistol | 5 | 10m | 3D-3 | 1 | Cr200 | 15 | Cr10 | — |
| Body Pistol | 8 | 5m | 2D | — | Cr500 | 6 | Cr10 | — |
| Gauss Pistol | 13 | 20m | 3D | 1 | Cr500 | 40 | Cr20 | AP 3, Auto 2 |
| Revolver | 4 | 10m | 3D-3 | 0.5 | Cr150 | 6 | Cr5 | — |
...
| Antique Rifle | 2 | 25m | 3D-3 | 3 | Cr150 | 1 | Cr10 | — |
...
| Rifle | 5 | 250m | 3D | 3 | Cr200 | 5 | Cr10 | — |
...
**Shotgun:** Shotguns are smoothbore weapons that typically fire ammunition containing multiple small pellets. They are most effective at short range. A shotgun using pellet ammunition ignores Dodge dice modifiers but armour gives double Protection against pellet attacks.
...
### Energy Weapons
Directed-energy weapons first enter the battlefield as target designators and range-finders but by TL9 weapons capable of inflicting damage directly appear.

Laser weapons require a power supply – pistols come with a belt- or wrist-mounted power pack, while rifles come with backpacks connected by a cable. As the Tech Level increases, power packs gradually become integrated into the weapons themselves.
...
| WEAPON | TL | RANGE | DAMAGE | KG | COST | MAGAZINE | PACK COST | TRAITS |
|--------|----|-------|--------|----|------|----------|-----------|--------|
| **POWER PISTOLS** | | | | | | | | |
...
| Laser Carbine | 11 | 200m | 4D+3 | 2 | Cr4000 | 50 | Cr3000 | Zero-G |
| Laser Rifle | 9 | 200m | 5D | 5 | Cr3500 | 100 | Cr1500 | Zero-G |
| Laser Rifle | 11 | 400m | 5D+3 | 3 | Cr8000 | 100 | Cr3500 | Zero-G |
| Laser Sniper Rifle | 12 | 600m | 5D+3 | 4 | Cr9000 | 6 | Cr250 | Scope, Zero-G |
| Plasma Rifle | 16 | 300m | 6D | 4 | Cr100000 | Unlimited | — | — |

**Laser Pistol:** The TL9 pistol is bulky but effective, with no recoil and a large magazine. At TL11, advances in battery technology and miniaturisation mean the pistol is no larger than a conventional firearm but must still be connected to a battery pack for sustained use.
...
| WEAPON | TL | RANGE | DAMAGE | KG | COST | MAGAZINE | MAGAZINE COST | TRAITS |
|--------|----|-------|--------|----|------|----------|---------------|--------|
| FGHP-14 | 14 | 450m | 2DD | 12 | Cr100000 | — | — | Radiation, Very Bulky |
| FGHP-15 | 15 | 450m | 2DD | 12 | Cr400000 | — | — | Bulky, Radiation |
| FGHP-16 | 16 | 450m | 2DD | 15 | MCr0.5 | — | — | Radiation |
| Grenade Launcher | 7 | 100m | As grenade | 6 | Cr400 | 6 | As grenades | Bulky |
| Machinegun | 6 | 500m | 3D | 10 | Cr1500 | 60 | Cr100 | Auto 4 |
| PGHP-12 | 12 | 250m | 1DD | 10 | Cr20000 | — | — | Very Bulky |
| PGHP-13 | 13 | 450m | 1DD | 10 | Cr65000 | — | — | Bulky |
| PGHP-14 | 14 | 450m | 1DD | 10 | Cr100000 | — | — | — |
| RAM Grenade Launcher | 8 | 250m | As grenade | 2 | Cr800 | 6 | As grenades | Auto 3, Bulky |
| Rocket Launcher | 6 | 120m | 4D | 8 | Cr2000 | 1 | Cr300 | Blast 6 |
| Rocket Launcher | 7 | 150m | 4D+3 | 8 | Cr2000 | 1 | Cr400 | Blast 6, Smart |
| Rocket Launcher | 8 | 200m | 5D | 8 | Cr2000 | 2 | Cr600 | Blast 6, Scope, Smart |
| Rocket Launcher | 9 | 250m | 5D+6 | 8 | Cr2000 | 2 | Cr800 | Blast 6, Scope, Smart |
...
**Machinegun:** A larger and less portable version of the autorifle, the machinegun may be relatively low tech but it is capable of sawing even armoured targets in half.
...
**Rocket Launcher:** A simple tube device that launches rockets. Anyone standing behind a rocket launcher when it is fired will be caught in its back blast and suffer 3D damage from the burning gases. It takes three Minor Actions to reload a rocket launcher.
...
Doubling the amount of explosives used will increase the Damage by 1D and the Blast by +1. Continually doubling the amount of explosives used will have a cumulative effect.
...
**Gyrostabiliser (TL9):** Stabilisers can be added to any Bulky weapon, reducing its recoil and removing the Bulky trait at a cost of Cr500. They cannot be added to any Destructive weapon.

**Intelligent Weapon (TL11):** This adds Computer/0 to any weapon. Costs Cr1000.
TL13: This adds Computer/1 to any weapon. Costs Cr5000.

**Laser Sight (TL8):** Integrated optics and laser sights grant DM+1 to any attack made at less than 50 metres. Costs Cr200.
TL10: Ultraviolet lasers and improved display technology removes the tell-tale 'red dot' of a vislight laser.

**Scope (TL5):** A high-quality telescopic scope for attachment to a rifle or heavy weapon, allowing accurate shots to be made at extreme ranges. Any rifle or heavy weapon equipped with this gains the Scope trait. Costs Cr50.
...
| Speed Bands | Speed Band Number | Kilometres per Hour |
|-------------|-------------------|---------------------|
| Stopped | 0 | 0 |
| Idle | 1 | 1–20 |
| Very Slow | 2 | 20–50 |
...
| Fast | 6 | 300–500 |
| Very Fast | 7 | 500–800 |
| Subsonic | 8 | 800–1,200 |
| Supersonic | 9 | 1,200–6,000 |
| Hypersonic | 10 | 6,000 or more |
...
### Airborne Movement
Most aircraft (vehicles that use the Flyer skill) are designed for a specific atmosphere and planetary gravity. This means aircraft can only fly on worlds with Size and Atmosphere codes within two of their world of creation. For example, an aircraft manufactured on a world with Size 7 and Atmosphere 7 could function properly on worlds with Atmosphere 5–9, and Size 5–9.
...
* Vehicles are considered to move on the driver's Initiative. The driver must spend a Minor Action every round to keep control of the vehicle under normal circumstances – a straight road or simple manoeuvres – or a Significant Action to navigate obstacles, conduct evasion or pursue a target.
...
**Dogfight:** A vehicle within one kilometre and within one Speed Band of another may initiate a dogfight. This is a series of manoeuvres whereby the driver of one vehicle attempts to gain a position of advantage over another and, hopefully, destroy it.
...
**Manoeuvre:** A driver can manoeuvre their vehicle without making any skill checks. This allows the vehicle to avoid large or obvious obstacles, get to where it is going, move out of one fire arc of an enemy vehicle and into a different one, or change the fire arc a single target is in. More extreme manoeuvres are covered by the Stunt action.
...
#### Fire Arcs
Weapons mounted on vehicles are limited in what direction they can fire. A weapon mounted in the front arc, for example, can only fire into a 90° area in front of the vehicle. Weapons in turrets can fire in any direction. What weapons a vehicle has in which fire arcs is listed in its description.

### Damaging Vehicles
Once the total amount of damage a weapon is causing has been calculated, any armour the vehicle has is deducted from it. Some vehicles have different armour scores on different facings – the armour used against a weapon is always the facing the attack is made from. Basically, if an attack is made to the side of a vehicle, the vehicle will use its side armour against the attack.
...
Against any weapon that has less than Damage 4D or has the Stun trait, a vehicle will have an extra amount of armour equal to its TL on each facing.
...
The Severity of the critical hit is equal to the Effect of the attack roll minus 5. Consult the Critical Hit Effects table to determine the nature of the critical hit and how it affects the vehicle. Any extra damage caused by the effects of critical hits ignores the vehicle's Armour.
...
| **Armour** | | Armour on the facing hit reduced by -1 | Armour on the facing hit reduced by -1D | Armour on the facing hit reduced by -1D | Armour on the facing hit reduced by -2D | Armour on the facing hit reduced by -2D, Hull Severity increased by +1 | Armour on the facing hit reduced by -2D, Hull Severity increased by +1 |
...
| **Systems** | | All checks to use comms, sensors and computers suffer DM-2 | Roll 1D. The vehicle loses the use of 1–2: Comms, 3–4: Sensors, 5–6: Computer | Roll 1D. The vehicle loses the use of 1–2: Comms, 3–4: Sensors, 5–6: Computer | Roll 1D. The vehicle loses the use of 1–2: Comms, 3–4: Sensors, 5–6: Computer | Hull Severity increased by +1 | Hull Severity increased by +1 |

#### Sustained Damage
A vehicle will also have its components degraded through sustaining constant damage. Every time a vehicle sustains damage equalling 10% of its starting Hull score, roll 2D and then consult the Critical Hits Location table. The vehicle will suffer a Severity 1 critical hit to that location.
...
Any unsecured passengers in a vehicle damaged in a collision take the same damage and, in open vehicles, are thrown 10 metres for every Speed Band Number. Damage to passengers involved in collisions ignores any personal armour.
...
All these weapons require the Heavy Weapons (vehicle) skill. Note that, for these weapons, ranges are listed in kilometres and tons are used instead of kilograms for mass.

| Vehicle Weapons | TL | Range | Damage | Tons | Cost | Magazine | Magazine Cost | Traits |
|-----------------|----|-------|--------|------|------|----------|---------------|--------|
...
### Vehicle Equipment
The following items can be found on vehicles as part of their standard specification or may be added later.

Equipment and weapons may be mounted on any vehicle that has enough spare cargo space. Items massing less than 250kg do not require any cargo space in a vehicle.
...
TL6: Range increases to 50km.
TL8: Range increases to 500km and can communicate with overhead satellites. Can also use lasers or masers to precisely aim a signal so it cannot be intercepted.
TL15: Range increase to 5,000km.
...
**Navigation:** From simple GPS systems to intelligent location-scanning guidance systems, this equipment helps a vehicle's crew find their way around. Provides DM+1 to all Navigation checks.
Improved: Provides DM+2 to all Navigation checks.
Advanced: Provides DM+3 to all Navigation checks.
...
**Sensors:** At low Tech Levels, sensors may be little more than headlights and a pair of binoculars but as technology increases, they become increasingly more sophisticated and capable. Even basic civilian vehicles may start to sport radar, densitometers and thermal systems. The range of basic sensors is one kilometre but note that Tech Level is a very important component to the capability of sensors. For every three Tech Levels above TL5, increase the cost of the sensors by +50%.
Improved: Provides DM+1 to all Electronics (sensors) checks and increases range to 5km.
Advanced: Provides DM+2 to all Electronics (sensors) checks and increases range to 25km.
...
| Vehicle Equipment | TL | Tons | Cost |
|-------------------|----|------|------|
| Autopilot | 5 | — | Cr2000 |
...
| Sensors (advanced) | 12 | 0.25 | Cr25000 |
...
| SHIPPING | 4 tons |
| COST | Cr250000 |
| ARMOUR | FRONT 10 REAR 10 SIDES 10 |
...
An enclosed, pressurised all-terrain ground vehicle. The vehicle is capeable of floating on calm water and has a suit of built-in sensors and communication equipment (usually a laser tranceiver) making it ideal for exploration. An ATV has a hardpoint for a turret but does not normally come with a weapon

NOTE: A tracked version of the ATV is available. This uses the Drive (track) skill, has Speed: Medium (slow) and costs Cr175000.

### Brutus Heavy Cargo Truck (TL10)
| | |
|---|---|
| SKILL | Drive (wheel) |
| AGILITY | -2 |
...
| SHIPPING | 40 tons |
| COST | Cr241000 |
| ARMOUR | FRONT 8 REAR 8 SIDES 8 |
| EQUIPMENT AND WEAPONS | Camouflage (basic), Communication system (improved), Crane (medium), Navigation System (improved) |

While lacking the glamour of armoured vehicles and aircraft, the ability to deliver supplies and ammunition to forward bases, not to mention shipping out wounded, is a fundamental requirement for any mercenary force not wanting to rely on their employers.

This truck is large, built with the assumption that a mercenary force needs the greatest carrying capability within as few separate vehicles as possible.
...
Designed to transport a fire team or VIP through a war zone, the Gecko can handle a wide veriety of terrain at some speed and, despite being only semi-enclosed, its armour is sufficient to resist small arms fire of an equivalent Tech Level. It also sports a powerful punch, with twin-linked autocannon mounted on the roof.

| WEAPON | RANGE | FIRE ARCS | DAMAGE | MAGAZINE | MAGAZINE COST | TRAITS |
|--------|--------|----------|--------|----------|---------------|--------|
| Twin Light Autocannon | 1 | | 6D+6 | 500 | Cr2000 | Auto 3 |
...
The flat bed nature of the Gunskiff means that if it does not carry passengers, it can easily accommodate one ton of cargo.

| WEAPON | RANGE | FIRE ARCS | DAMAGE | MAGAZINE | MAGAZINE COST | TRAITS |
|--------|--------|----------|--------|----------|---------------|--------|
| Laser Cannon | 2.5 | | 1DD | — | — | AP 10 |

### Personal Land Yacht (TL3)
| | |
|---|---|
| SKILL | Drive (wheel) |
| AGILITY | -1 |
...
| EQUIPMENT AND WEAPONS | A FV, Autopilot, Communications System (advanced), Computer/5, Navigation (advanced), Sensor System (advanced) |
| Turret (Fusion Gun) | | | | | | | |

A grav carrier is effectively a flying armoured personnel carrier and is a standard fighting vehicle of many military forces across Charted Space.

| WEAPON | RANGE | FIRE ARCS | DAMAGE | MAGAZINE | MAGAZINE COST | TRAITS |
|--------|--------|----------|--------|----------|---------------|--------|
| Fusion Gun | 5 | | 3DD | — | — | AP 20, Blast 20, Radiation |
...
**Capital Ship:** A ship of more than 5,000 tons.
...
**Partially Streamlined Hull:** These ships may enter atmospheres but are not specifically designed to do so and are extremely ungainly.
**Unstreamlined Hull:** These ships are completely non-aerodynamic. While they can potentially enter atmospheres, this tends to be very dangerous.
...
Every time a ship is rolled as a Benefit, **25% of the original mortgage has been paid off**. In practice, the Traveller may choose to:
* Continue to pay the calculated mortgage for **10 years less** every time the Benefit is rolled (continuing the mortgage) and pay their ship off faster, or
* Deduct **25% from the purchase price** of the ship before calculating the mortgage cost (effectively re-mortgaging) to be paying less every four weeks.
...
* **Streamlined hull**: Designed to enter a planetary atmosphere and can function like a conventional aircraft. Pilot checks are required in high winds and other extreme weather.
* **Partially streamlined hull**: Allows a ship to skim gas giants and enter Atmosphere codes of 3 or less. In other atmospheres, the ship will be ponderous and unresponsive, reliant on its thrusters to keep it aloft. All Pilot checks will be made with DM-2.
* **Unstreamlined hull**: Completely non-aerodynamic. If it enters an atmosphere it runs the risk of sustaining serious damage. Such a ship must make a Pilot check at DM-4 when it enters an atmosphere and for every minute of flight. Each failed check inflicts 1D damage to the ship, ignoring any Armour.

### Docking and Landing
* **Landing**: Landing at a starport requires a Routine (6+) Pilot check (1D × 10 seconds) but most pilots will take 1D minutes to perform a landing and gain DM+2 on the task. Ships have landing gear, allowing them to touch down 'in the wild', which requires an Average (8+), Difficult (10+) or even Very Difficult (12+) Pilot check, depending on local terrain. They can also land on bodies of water. Failing a Pilot check while attempting a landing means the ship has landed improperly or even crashed.
* **Docking**: Two spacecraft may dock if they are close together and neither ship attempts to resist the docking manoeuvre. Docking with another vessel requires a Routine (6+) Pilot check (1D minutes).

### Power
Every spacecraft has a power plant that produces an amount of Power. Under normal circumstances, most ships will produce enough Power to run all systems and weapons without any attention needed from the crew.

A ship needs the following Power points available for each of these listed systems:

| System | Power Required |
|--------|----------------|
| Basic Ship Systems | 20% of the total tonnage of the hull |
| Manoeuvre Drive | 10% of hull tonnage × ship's maximum Thrust |
| Jump Drive | 10% of hull tonnage × ship's maximum jump range (only needed when initiating a jump) |
| Beam Laser | 4 |
| Missile Rack | 0 |
| Particle Beam | 8 |
| Pulse Laser | 4 |
...
If the amount of Power available drops below requirements, the crew must shut down various systems:
* **Basic Ship Systems**: Non-essential systems can be shut down on a temporary basis, which will halve the amount of Power needed for basic ship systems.
* **Manoeuvre Drive**: Can be throttled back or shut off altogether, saving Power equal to 10% of the ship's total tonnage multiplied by the Thrust being deducted.
* **Jump Drive**: Does not ordinarily drain any Power until it is used.
* **Weapons and Systems**: Individual weapons and systems can be switched off on a temporary basis, regaining the amount of Power listed in the table above.

### Running Costs and Maintenance
A starship operator faces many costs every four weeks (a Maintenance Period):
...
|----|---------------------|
| 2–4 | Fuel Leak: The spacecraft loses 1D × 10% of its fuel capacity |
| 5–7 | Drive Damaged: Roll 1D. On 1–3, the manoeuvre drive is hit; reduce Thrust by -1 and all Pilot checks suffer DM-1. On 4–6, the jump drive is hit and disabled |
| 8–9 | Weapon Faulty: One random turret (or weapon, if no turrets are present) is damaged; DM-1 on all attack rolls made with it |
| 10–12 | Power Plant: The spacecraft's Power is reduced by 25% and it takes 1D extra damage, ignoring armour. All crew suffer 2D × 10 rads per week |

### Encounters
To generate a random encounter, roll 1D every day. On a 6, the ship has encountered something – roll D66 on the Space Encounters table, applying the following DMs to the first dice rolled:
...
**Space Encounters Table (excerpt)**
| D66 | Encounter | D66 | Encounter |
|-----|-----------|-----|-----------|
| 01 | Alien Derelict (Possible Salvage) | 51 | Hostile Vessel (Roll Again for Type) |
| 02 | Solar Flare (1D × 100 rads) | 52 | Garbage Ejected From a Ship |
| 03 | Asteroid (Empty Rock) | 53 | Medical Ship or Hospital |
| 04 | Ore-Bearing Asteroid | 54 | Lab Ship or Scout |
| 05 | Alien Vessel (On a Mission) | 55 | Patron |
| 06 | Rock Hermit (Inhabited Rock) | 56 | Police Ship |
| 11 | Pirate | 61 | Unusually Daring Pirate |
| 12 | Derelict Vessel (Possible Salvage) | 62 | Noble Yacht |
| 13 | Space Station (1–4: Derelict, 5–6: Operational) | 63 | Warship |
| 14 | Comet (May be Ancient Derelict at its Core) | 64 | Cargo Vessel |
| 15 | Ore-Bearing Asteroid | 65 | Navigational Buoy or Beacon |
| 16 | Ship in Distress (Roll Again for Type) | 66 | Unusual Ship |

### Fuel
Most ships use refined hydrogen as fuel for their fusion power plants and jump drives. Starports offer refuelling facilities. Hydrogen costs **Cr500 per ton for refined fuel** or **Cr100 per ton for unrefined fuel**.

A ship with fuel scoops may gather fuel from bodies of water using hoses. It may also scoop hydrogen from a gas giant, requiring a Difficult (10+) Pilot check (1D hours, DEX). Fuel gathered in the wild is unrefined but a ship with fuel processors may refine it.

### Jump Travel
Jump travel is the only known means by which a vessel may travel faster than light. To jump, a ship creates a bubble of hyperspace by means of injecting high-energy exotic particles into an artificial singularity.

A ship can only safely jump when it is more than **100 diameters** distant from any object larger than the ship.

#### Preparing for Jump
To jump, the following procedures must be performed as a task chain:

1. **Astrogation**: The jump needs to be plotted. This is an Easy (4+) Astrogation check (1D × 10 minutes, EDU), modified by the jump distance (thus, a jump covering four parsecs gives DM-4 to the check).
2. **Jump!**: Firing the jump drive requires an Easy (4+) Engineer (j-drive) check (1D × 10 minutes, EDU), modified by the task chain of the original Astrogation check and the following modifiers:
...
3. **Divert Power**: A jump drive requires a tremendous amount of power to function, which must be supplied by the ship's power plant.

When making a jump, a ship will use an amount of fuel equal to **10% of its hull tonnage for every parsec jumped**. Regardless of how far the ship jumps, it always stays in jumpspace for roughly **one week (148 + 6D hours)**.

#### Misjumps
* Failed by Effect of -1: Ship arrives in the target system but appears **1D days later** than normal.
* Failed by Effect of -2: Ship arrives in the target system but finds itself a number of **100-diameters away from the intended world multiplied by 1D**.
* Worse Effect: Ship ends up **1D × 1D parsecs in a random direction**, potentially in deep (and empty) space.

### Passengers
Passenger travel within the Imperium has been standardised into five categories:

| Category | Description |
|----------|-------------|
| **High Passage** | Best possible treatment. Passenger receives a stateroom and one ton of cargo space for baggage. One level of the Steward skill is required for every 10 high passengers. |
| **Middle Passage** | Generally sold on a stand-by basis so middle passengers can be 'bumped' by high passengers who arrive later. Baggage allowance is 100kg. One level of the Steward skill is required for every 100 middle passengers. |
| **Basic Passage** | Also called steerage. Two basic passengers can be crammed into one stateroom. Two tons of space is required for every basic passenger not in a stateroom. Baggage allowance is 10kg. |
| **Working Passage** | Identical to middle passage but the passenger pays their way by serving on board ship in some capacity. |
| **Low Passage** | A low passenger is frozen in a low berth and counts as cargo. A Routine (6+) Medic check (1D × 10 minutes, INT) is required upon opening the capsule. If the check fails, the passenger does not survive. |

### Sensors
All spacecraft have advanced sensors that allow them to spot potential threats and items of interest from possibly thousands of kilometres distant.
...
* **EM (all)**: Sensors detecting emissions across the electromagnetic spectrum
* **Radar/Lidar (all)**: Detects physical objects
...
Ship computers are much more powerful than those commonly used planetside.

**Ship Software**
| Program | TL | Bandwidth | Cost (MCr) | Effect |
|---------|----|-----------|------------|--------|
| Manoeuvre | 8 | 0 | Included | Allows basic control of ship |
| Intellect | 11 | 0 | Included | Allows a ship to understand and obey verbal commands |
| Jump Control/1 | 9 | 5 | 0.1 | Allows jumps of up to 1 parsec |
| Jump Control/2 | 11 | 10 | 0.2 | Allows jumps of up to 2 parsecs |
| Jump Control/3 | 12 | 15 | 0.3 | Allows jumps of up to 3 parsecs |
| Jump Control/4 | 13 | 20 | 0.4 | Allows jumps of up to 4 parsecs |
| Jump Control/5 | 14 | 25 | 0.5 | Allows jumps of up to 5 parsecs |
| Jump Control/6 | 15 | 30 | 0.6 | Allows jumps of up to 6 parsecs |
| Evade/1 | 9 | 10 | 1 | Computer applies negative DM equal to program's score to all attacks |
| Evade/2 | 11 | 15 | 2 | As above, with DM-2 |
| Evade/3 | 13 | 25 | 3 | As above, with DM-3 |
| Fire Control/1 | 9 | 5 | 2 | Allows computer to fire 1 turret per round or grant DM+1 to attack |
| Fire Control/2 | 10 | 10 | 4 | Allows computer to fire 2 turrets per round or grant DM+2 to attack |
| Fire Control/3 | 11 | 15 | 6 | Allows computer to fire 3 turrets per round or grant DM+3 to attack |
| Fire Control/4 | 12 | 20 | 8 | Allows computer to fire 4 turrets per round or grant DM+4 to attack |
| Fire Control/5 | 13 | 25 | 10 | Allows computer to fire 5 turrets per round or grant DM+5 to attack |
| Auto-Repair/1 | 10 | 10 | 5 | Allows computer to make 1 repair attempt per round (requires repair drones) |
| Auto-Repair/2 | 12 | 20 | 10 | Allows computer to make 2 repair attempts per round (requires repair drones) |
| Library | 8 | 0 | Included | Contains a wealth of data on numerous subjects |

### Space Combat

#### Combat Rounds
Combat between spacecraft uses a **six minute combat round** (rather than six seconds). When spacecraft are involved in combat against Travellers or vehicles directly or against other spacecraft at Close range (10km or less) use the Dogfighting rules.
...
3. **Actions Step**: In order of Initiative, ships can perform other miscellaneous actions.

#### Initiative
Roll: **2D + the pilot's Pilot skill + the ship's Thrust score**

#### Spacecraft Damage Scale
Spacecraft use a different damage scale than ground targets:

| Attacking a... | Ground Weapon (DM to hit) | Ground Weapon (Damage) | Spacecraft Weapon (DM to hit) | Spacecraft Weapon (Damage) |
|----------------|---------------------------|------------------------|-------------------------------|----------------------------|
| Ground Target | +0 | ×1 | -2 | ×10 |
| Spacecraft | +2 | ÷10 | +0 | ×1 |
...
*\* After taking into account any armour, multiply all damage from a Particle Barbette by 3.*

#### Critical Hits
If an attack roll against a spacecraft has an Effect of 6 or higher and it causes damage, a critical hit has been scored.
...
*(Full Critical Hit Effects table with Severity levels 1-6 for each location continues in the rulebook)*

#### Boarding Actions
Once two ships are within less than one kilometre of each other (Adjacent range), marines can launch a boarding action during the Actions Step. A boarding action takes 2D rounds to complete.

**Boarding Action Modifiers**
* Superior Armour: +1
* Superior Weaponry: +1
...
**Boarding Actions Results**
| Total | Result |
|-------|--------|
| -7 or less | Attackers soundly defeated. Defenders may mount counter-boarding action with DM+4 |
| -4 to -6 | Attackers defeated and must retreat |
| -1 to -3 | Fighting continues. Resolve again in 1D rounds; defender gains DM+2. Ship being boarded loses 2D Hull |
| 0 | Fighting continues. Resolve again in 1D rounds |
| 1 to 3 | Fighting continues. Resolve again in 1D rounds; attacker gains DM+2. Ship being boarded loses 2D Hull |
| 4 to 6 | Boarding action successful. Ship being boarded suffers 1D damage ignoring armour. Attackers may take control after another 2D rounds |
| 7 or more | Attackers storm the enemy ship and take control immediately |

## Spacecraft Construction

The spacecraft construction system allows you to create your own ships or reverse engineer existing designs.

### Design Checklist
1. Create a Hull
2. Install Drives (Manoeuvre and Jump)
3. Install Power Plant
4. Install Computer and any Software
5. Install Bridge
6. Install Sensors
7. Install Armour
8. Install Weapons
9. Install Staterooms (including low berths)
10. Install Optional Systems (such as smaller craft and fuel purification plants)
11. Allocate Cargo Space
12. Determine Crew
13. Finalise Design

### Step 1: Create a Hull
Decide on the total tonnage of the ship. A basic hull costs **Cr50,000 per ton**. The ship will have **1 Hull point for every full 2.5 tons** of hull.
...
* **Streamlined hull**: Designed to enter a planetary atmosphere and can function like a conventional aircraft.
* **Partially streamlined hull**: Allows a ship to skim gas giants and enter Atmosphere codes of 3 or less.
* **Unstreamlined hull**: Completely non-aerodynamic. If it enters an atmosphere it runs the risk of sustaining serious damage.

Starting at TL9, all hulls are self-sealing. A self-sealing hull automatically repairs minor breaches such as micrometeoroid impacts.

#### Hull Armour
| Armour | TL | Tonnage Consumed | Cost (% of hull) | Max. Protection |
|--------|----|------------------|-----------------|-----------------|
| Crystaliron | 10 | 1.25% | 5% | TL or 13 (whichever is less) |
| Bonded | 14 | 0.80% | 8% | TL |
| Superdense | 16 | 0.50% | 12% | TL+2 |

### Step 2: Install Drives

#### Thrust Potential
| Manoeuvre Drive Rating | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |
|------------------------|---|---|---|---|---|---|---|---|---|
| % of Hull | 1% | 2% | 3% | 4% | 5% | 6% | 7% | 8% | 9% |
| Manoeuvre TL | 9 | 10 | 10 | 11 | 11 | 12 | 12 | 13 | 13 |

Manoeuvre drives cost **MCr2 per ton**.

#### Jump Potential
| Rating | 1 | 2 | 3 | 4 | 5 | 6 |
|--------|---|---|---|---|---|---|
| % of Hull | 2.5% | 5% | 7.5% | 10% | 12.5% | 15% |
| Jump TL | 9 | 11 | 12 | 13 | 14 | 15 |

Jump drives cost **MCr1.5 per ton** and must be a minimum of 10 tons.
...
* **Manoeuvre Drive**: 10% of hull tonnage × maximum Thrust
* **Jump Drive**: 10% of hull tonnage × maximum jump number (only needed when initiating a jump)

### Step 4: Install Computer and Software
Ship computers are much more powerful than those commonly used planetside.
...
Every ship requires a bridge to coordinate its operations. A basic bridge requires **1 ton** and costs **MCr0.5**. The bridge includes command chairs, control consoles, status displays and communications equipment.

### Step 6: Install Sensors
All spacecraft have advanced sensors that allow them to spot potential threats and items of interest.
...
| Sensor Package | TL | Tons | Cost | Range | DM to Electronics (sensors) checks |
|----------------|----|------|-------|-------|-----------------------------------|
| Basic | 7 | 1 | MCr0.1 | Medium | +0 |
| Improved | 9 | 2 | MCr0.5 | Long | +1 |
| Advanced | 12 | 4 | MCr2 | Very Long | +2 |
| Military | 14 | 6 | MCr5 | Distant | +3 |

### Step 7: Install Armour
Armour provides protection against attacks. All hulls start with armour Protection +0, although this can be improved upon. Dispersed structure ships cannot be given increased armour.

*(See Hull Armour table above in Step 1)*

### Step 8: Install Weapons
Weapons may be mounted in turrets or fixed mounts.

#### Turret Mounts
| Mount | TL | Tons | Cost |
|-------|----|------|------|
| Single Turret | 7 | 1 | MCr0.2 |
| Double Turret | 8 | 1 | MCr0.5 |
| Triple Turret | 9 | 1 | MCr1 |

Every 100 tons of the ship's hull allows one turret to be installed.
...
**Double and Triple Turrets:** If two or more weapons of the same type are mounted in a double or triple turret, they may be fired together. One attack roll is made for all weapons being fired, but each additional weapon adds +1 per damage dice to the final damage total.

### Step 9: Install Staterooms
Staterooms provide living quarters for the crew and passengers.

* **Standard Stateroom**: 4 tons, Cr500,000 – Accommodates one person comfortably for extended periods
* **Low Berth**: 0.5 tons, Cr100,000 – Suspends a person in cryogenic stasis; requires Routine (6+) Medic check to revive occupant

### Step 10: Install Optional Systems
Various optional systems may be installed:

| System | TL | Tons | Cost | Effect |
|--------|----|------|------|--------|
| Fuel Scoops | 7 | 1 | MCr0.1 | Allows refuelling from gas giants or bodies of water |
| Fuel Purifiers | 9 | 1 | MCr0.5 | Allows refining of unrefined fuel |
| Workshop | 8 | 10 | MCr1 | Allows repairs to be made with Mechanic skill |
| Sick Bay | 9 | 10 | MCr2 | Provides advanced medical facilities |
| Laboratory | 10 | 20 | MCr5 | Allows scientific analysis and research |
| Hangar | — | 30 | MCr2 | Holds one 30-ton craft (add 30 tons and MCr2 for each additional craft) |

### Step 11: Allocate Cargo Space
Any remaining tonnage after all other systems have been installed becomes cargo space. One ton of cargo space can hold approximately 14 cubic metres of goods.

### Step 12: Determine Crew
The minimum crew requirements for a ship depend on its systems:

| Position | Required For | Minimum Skill |
|----------|--------------|---------------|
| Pilot | Manoeuvring ship | Pilot 0 |
| Astrogator | Plotting jumps | Astrogation 0 |
| Engineer | Maintaining drives and power plant | Engineer (any) 0 |
| Gunner | Operating weapons | Gunner (any) 0 |
| Medic | Operating sick bay (if present) | Medic 0 |
| Steward | Caring for passengers (if present) | Steward 0 |

### Step 13: Finalise Design
Calculate the final statistics for your ship:

* **Total Cost**: Sum of all components
* **Annual Maintenance**: 0.1% of purchase price divided by 12 per Maintenance Period
* **Mortgage Payment**: Total purchase price divided by 240 per Maintenance Period (40-year term)
* **Crew Salaries**: As per Running Costs table (page 154)
...
### Example: 200-ton Far Trader (continued)
* Hull (200 tons, streamlined): Cr12,000,000 (+20%)
* Armour (Crystaliron, Protection 10): 25 tons, Cr6,000,000
* Manoeuvre Drive-2 (4 tons): MCr8
* Jump Drive-2 (15 tons): MCr22.5
* Power Plant (28 tons): MCr14
* Bridge (1 ton): MCr0.5
* Computer/3: MCr3
* Sensors (Improved): MCr0.5
* Weapons (2 triple turrets with pulse lasers): 2 tons, MCr6.5
* Staterooms (6): 24 tons, MCr3
* Fuel (40 tons for jump-2 + 20 tons for manoeuvring): 60 tons
* Cargo: 43 tons
* **Total Cost**: MCr38.5
* **Mortgage**: Cr160,417 per Maintenance Period

### Common Spacecraft
The following spacecraft are commonly encountered throughout Charted Space. Each entry includes specifications sufficient for gameplay.

#### Type S Scout/Courier (TL12)
| | |
|---|---|
| **Hull** | 100 tons, Streamlined |
| **Power Plant** | Fusion (TL12), Power 15 |
| **Jump Drive** | Jump-2 (10 tons) |
| **Manoeuvre Drive** | Thrust 2 (2 tons) |
| **Computer** | Computer/3bis |
| **Bridge** | Standard bridge with 2 workstations |
| **Hardpoints** | 1 |
| **Weapons** | 1 triple turret (pulse laser, sandcaster, missile rack) |
| **Armour** | Crystaliron (Protection 10) |
| **Fuel** | 28 tons (20 for jump, 8 for manoeuvring) |
| **Cargo** | 16 tons |
| **Staterooms** | 6 |
| **Low Berths** | 4 |
| **Ship's Boat** | None |
| **Cost** | MCr43.5 (including 28 tons of fuel) |
| **Annual Maintenance** | Cr36,250 |

*The ubiquitous Scout/Courier is the backbone of interstellar exploration and courier services. Its modular design allows for mission-specific configurations.*

#### Type A Free Trader (TL11)
| | |
|---|---|
| **Hull** | 200 tons, Streamlined |
| **Power Plant** | Fusion (TL11), Power 30 |
| **Jump Drive** | Jump-2 (15 tons) |
| **Manoeuvre Drive** | Thrust 2 (4 tons) |
| **Computer** | Computer/2 |
| **Bridge** | Standard bridge with 3 workstations |
| **Hardpoints** | 2 |
| **Weapons** | 2 triple turrets (pulse laser, sandcaster, missile rack) |
| **Armour** | Crystaliron (Protection 12) |
| **Fuel** | 48 tons (40 for jump, 8 for manoeuvring) |
| **Cargo** | 76 tons |
| **Staterooms** | 6 |
| **Low Berths** | 4 |
| **Ship's Boat** | None |
| **Cost** | MCr37.76 (including 48 tons of fuel) |
| **Annual Maintenance** | Cr31,467 |

*The workhorse of independent traders throughout the Imperium. Its large cargo hold and respectable jump range make it ideal for speculative trading.*

#### Type R Subsidised Merchant (TL11)
| | |
|---|---|
| **Hull** | 400 tons, Streamlined |
| **Power Plant** | Fusion (TL11), Power 60 |
| **Jump Drive** | Jump-2 (30 tons) |
| **Manoeuvre Drive** | Thrust 2 (8 tons) |
| **Computer** | Computer/3 |
| **Bridge** | Standard bridge with 4 workstations |
| **Hardpoints** | 4 |
| **Weapons** | 4 triple turrets (pulse laser, sandcaster, missile rack) |
| **Armour** | Crystaliron (Protection 14) |
| **Fuel** | 88 tons (80 for jump, 8 for manoeuvring) |
| **Cargo** | 188 tons |
| **Staterooms** | 14 |
| **Low Berths** | 20 |
| **Ship's Boat** | 1 x 30-ton launch |
| **Cost** | MCr78.16 (including 88 tons of fuel) |
| **Annual Maintenance** | Cr65,133 |

*Operated under government subsidy to maintain trade routes to less profitable worlds. Captains must adhere to strict schedules and routes.*

#### Type M Subsidised Liner (TL12)
| | |
|---|---|
| **Hull** | 1,000 tons, Streamlined |
| **Power Plant** | Fusion (TL12), Power 150 |
| **Jump Drive** | Jump-2 (75 tons) |
| **Manoeuvre Drive** | Thrust 2 (20 tons) |
| **Computer** | Computer/4 |
| **Bridge** | Standard bridge with 6 workstations |
| **Hardpoints** | 10 |
| **Weapons** | 10 triple turrets (pulse laser, sandcaster, missile rack) |
| **Armour** | Crystaliron (Protection 16) |
| **Fuel** | 220 tons (200 for jump, 20 for manoeuvring) |
| **Cargo** | 200 tons |
| **Staterooms** | 50 |
| **Low Berths** | 100 |
| **Ship's Boat** | 2 x 30-ton pinnaces |
| **Cost** | MCr245.5 (including 220 tons of fuel) |
| **Annual Maintenance** | Cr204,583 |

*Luxury passenger transport operating on major trade routes. Features extensive entertainment facilities and spacious accommodations.*
...
| **Hull** | 100 tons, Streamlined |
| **Power Plant** | Fusion (TL12), Power 15 |
| **Jump Drive** | Jump-3 (15 tons) |
| **Manoeuvre Drive** | Thrust 4 (4 tons) |
| **Computer** | Computer/4 |
| **Bridge** | Luxury bridge with 2 workstations |
| **Hardpoints** | 1 |
| **Weapons** | 1 double turret (pulse laser, sandcaster) |
| **Armour** | Crystaliron (Protection 12) |
| **Fuel** | 35 tons (30 for jump, 5 for manoeuvring) |
| **Cargo** | 4 tons |
| **Staterooms** | 4 (luxury) |
| **Low Berths** | 2 |
| **Ship's Boat** | None |
| **Cost** | MCr55.75 (including 35 tons of fuel) |
| **Annual Maintenance** | Cr46,458 |

*Pleasure craft for the wealthy elite. Features opulent interiors and high performance drives.*

#### Type P Patrol Cruiser (TL13)
| | |
|---|---|
| **Hull** | 400 tons, Streamlined |
| **Power Plant** | Fusion (TL13), Power 80 |
| **Jump Drive** | Jump-4 (40 tons) |
| **Manoeuvre Drive** | Thrust 4 (16 tons) |
| **Computer** | Computer/5 |
| **Bridge** | Military bridge with 6 workstations |
| **Hardpoints** | 4 |
| **Weapons** | 2 triple turrets (pulse laser x2, missile rack), 2 double turrets (beam laser, sandcaster) |
| **Armour** | Bonded (Protection 14) |
| **Fuel** | 160 tons (160 for jump, 16 for manoeuvring) |
| **Cargo** | 12 tons |
| **Staterooms** | 12 |
| **Low Berths** | 8 |
| **Ship's Boat** | 1 x 30-ton launch |
| **Cost** | MCr187.2 (including 160 tons of fuel) |
| **Annual Maintenance** | Cr156,000 |

*Military patrol vessel used for system defense, customs enforcement, and anti-piracy operations.*

#### Fighter (TL12)
| | |
|---|---|
| **Hull** | 10 tons, Streamlined |
| **Power Plant** | Fusion (TL12), Power 2 |
| **Jump Drive** | None |
| **Manoeuvre Drive** | Thrust 6 (1 ton) |
| **Computer** | Computer/2 |
| **Bridge** | Single pilot station |
| **Hardpoints** | 1 |
| **Weapons** | Fixed mount (pulse laser), 1 single turret (missile rack) |
| **Armour** | Crystaliron (Protection 8) |
| **Fuel** | 2 tons |
| **Cargo** | None |
| **Staterooms** | 1 (pilot only) |
| **Low Berths** | None |
| **Ship's Boat** | None |
| **Cost** | MCr4.8 (including 2 tons of fuel) |
| **Annual Maintenance** | Cr4,000 |

*Atmospheric and space-capable fighter craft. Typically carried aboard larger warships or operating from planetary bases.*

### Ship Shares
Individual ship shares may be earned during careers, each worth **MCr1**. If applied toward the purchase of a ship, deduct MCr1 from the purchase cost for every share owned before calculating the mortgage.

### Career Benefits – Ships
Some careers award ships as benefits upon mustering out:

* **Navy**: Scout/Courier (Type S)
* **Merchants**: Free Trader (Type A)
* **Scouts**: Scout/Courier (Type S)
* **Army**: Armoured personnel carrier
* **Marines**: Grav carrier
* **Nobility**: Yacht (Type Y)

Every time a ship is rolled as a Benefit, **25% of the original mortgage has been paid off**. The Traveller may choose to:
* Continue the existing mortgage for **10 years less** per Benefit rolled, or
* Deduct **25% from the purchase price** before calculating a new mortgage (re-mortgaging)

### Ship Mortgages
Spacecraft mortgages typically run for **40 years** (480 Maintenance Periods). Monthly repayments are calculated by dividing the total purchase price by **240** (not 480 – payments are due every four weeks, not monthly).

**Example:** A MCr38.5 Far Trader requires payments of Cr160,417 every Maintenance Period for 40 years.

### Skipping on Debts
Ship captains who skip mortgage payments may be pursued by:
* Ship tracers (bounty hunters) employed by the bank
* Naval vessels if logged as criminals in the Imperial database

For each new system entered after skipping payment, roll 2D with modifiers:
* Per parsec distant from creditors: **DM-1** (resets when discovered)
* Ship modifications (repainting, transponder changes): **DM-1 to -6**
* Per MCr10 of ship value stolen: **DM+1**
* Previous visits to system (within 3 months): **DM+2**
* Payment less than 4 weeks overdue: **DM-4**
* Payment 4–24 weeks overdue: **DM+4**
* Payment 25 weeks to 1 year overdue: **DM+2**
* Payment more than 1 year overdue: **DM+0**
* Add local Law Level minus 5

On 8+, the Travellers will be hunted for their crimes.
...
* A cockpit is not designed for long term use and only has life support for 24 hours.

### STEP 6: INSTALL COMPUTER
Every ship needs a central computer, usually installed near the bridge. The computer is the heart of the ship, controlling all functions from life support to the complex calculations needed to perform a jump.

| Computer | Processing | Tech Level | Cost     |
|----------|------------|------------|----------|
...
**Jump Control Specialisation (/bis):** A computer's Processing score can be increased by +5 for the purposes of running Jump Control programs only by selecting this option. This increases the computer's cost by +50%.
...
| Advanced       | 15 | Densitometer, Jammers, Lidar, Neural Activity Sensor, Radar | +2 | 6 | 5 | MCr5.3 |
...
There are a multitude of optional systems, components and other accessories that can be added to a ship. These are covered on page 184. Note that most of these optional systems consume tonnage and some also require Power, both of which you should make careful note of.

### STEP 10: DETERMINE CREW
The Crew Requirements table shows how many crew are needed for a ship. Salary can vary but the values on the Crew Requirements table shows a monthly average for skill level 1 crew, with the presumption that salaries will increase by +50% for every skill level above this.

| Position   | Skills        | Salary   | Commercial                     | Military                       |
|------------|---------------|----------|--------------------------------|--------------------------------|
| Pilot      | Pilot         | Cr6000   | 1                              | 3                              |
| Astrogator | Astrogation   | Cr5000   | 1 if jump drive installed      | 1 if jump drive installed      |
| Engineer   | Engineer      | Cr4000   | 1 per 35 tons of drives and power plant | 1 per 35 tons of drives and power plant |
| Medic      | Medic         | Cr4000   | 1 per 120 crew and passengers  | 1 per 120 crew                 |
| Gunner     | Gunner        | Cr2000   | 1 per turret                   | 2 per turret                   |
| Steward    | Steward       | Cr2000   | 1 per 10 High or 100 Middle passengers | 1 per 10 High or 100 Middle passengers |
...
* A low berth can hold one low passenger.
* It consumes half a ton and costs Cr50000.
* Low berths require 1 Power for every 10 berths or part of.
...
Crew and passengers. This is not strictly necessary and ships can and will vary in this allocation, either increasing it to give crews and passengers a more luxurious (or at least more comfortable) journey or cutting back to give more space to useful components though at a cost of crew comfort. Common areas cost MCr0.1 per ton.
...
Weapons (both offensive and defensive in nature) are an important component for many ships.
...
Each weapon system uses one Hardpoint.
...
* A ship of less than 35 tons has one Firmpoint.
* A ship of 35–70 tons has two Firmpoints.
* A ship of 71–99 tons has three Firmpoints.
...
Turrets and fixed mounts use the same type of weapons but whereas a fixed mount may only fire at targets directly ahead of it, a turret rotates and may engage any target in sight.

One turret or fixed mount may be attached to each Hardpoint on a ship.

* Up to three weapons may be mounted on a fixed mount (small craft may only mount one weapon).
* Turrets can mount one, two or three weapons, depending on their type. These weapons need not be identical.
...
A smuggler's favourite, concealed compartments are cunningly hidden from visual searches and shielded against sensors, allowing them to be used to transport contraband or other questionable items.
...
Each ton consumed by fuel processors costs Cr50000.  
Fuel processors require 1 Power per ton.
...
Multiple holographic projectors are embedded within the hull allowing the ship to change hull colours, add graphics and adopt a different appearance (although its shape remains the same). Changing the hull colour or adding a stored graphic can be done by anyone with access to the ship's computer. Creating a complex colour scheme from scratch requires the talents of a skilled artist.
...
One ton of environmental equipment is needed for every 20 tons of space designated as multi-environment, at a cost of MCr0.5 per ton of equipment.  
Each ton of environmental equipment requires 1 Power.

### SENSOR STATION
While every bridge has equipment dedicated to monitoring and controlling the ship's sensors (even if this is tied into the pilot's own screens), some ships benefit from having additional stations to handle an increased number of sensor operators.

Some scout and survey ships feature additional sensor stations, while military vessels may feature similar stations dedicated to locating the enemy and electronic warfare.
...
Space ships are constructed and sold at shipyards throughout the galaxy. Any Class A starport has a shipyard that can build any kind of ship, including a starship with jump drives; any Class B starport can build small craft and ships that do not have jump drives.
...
| 6  | Damaged Sensors: DM-1 to all Electronics (sensors) checks. | Damaged Sensors: DM-1 to all Electronics (sensors) checks. | Damaged Sensors: DM-1 to all Electronics (sensors) checks. |
| 7  | DM-1 to all repair attempts.    | DM-1 to all repair attempts.      | DM-1 to all repair attempts.      |
| 8  | Double maintenance costs.       | Double maintenance costs.         | Double maintenance costs.         |
| 9  | Severely Damaged: -10% Hull.    | Severely Damaged: -10% Hull.      | Severely Damaged: -10% Hull.      |
| 10 | Damaged Thrusters: DM-1 to all Pilot checks. | Damaged Thrusters: DM-1 to all Pilot checks. | Damaged Thrusters: DM-1 to all Pilot checks. |
...
## SPECIFIC SHIP DESIGNS

### SCOUT/COURIER (TYPE: S)
TL12 | 100 tons, Streamlined

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 6          |
| Armour (Crystaliron, Armour: 4) | 5 | 1.2 |
...
| J-Drive (Jump-2)        | 10   | 15         |
| Power Plant (Fusion, Power 60) | 4 | 4 |
| Fuel Tanks (J-2, 4 weeks operation) | 21 | — |
| Bridge                  | 10   | 0.5        |
| Computer (Computer/5bis)| —    | 0.045      |
| Sensors (Military Grade)| 2    | 4.1        |
| Weapons (Double Turret) | 1    | 0.5        |
...
**Hull:** 40  
**Running Costs:**  
MAINTENANCE COST: Cr2804/month  
PURCHASE COST: MCr33.8355  
...
| Power Plant (Fusion, Power 75) | 5 | 5 |
| Fuel Tanks (J-1, 4 weeks operation) | 21 | — |
| Bridge                  | 10   | 1          |
...
**Hull:** 80  
**Running Costs:**  
MAINTENANCE COST: Cr3861/month  
PURCHASE COST: MCr46.332  
...
| Fuel Tanks (J-2, 4 weeks operation) | 41 | — |
| Bridge                  | 10   | 1          |
| Computer (Computer/5bis)| —    | 0.045      |
| Sensors (Civilian Grade)| 1    | 3          |
| Weapons                 | —    | —          |
...
**Hull:** 80  
**Running Costs:**  
MAINTENANCE COST: Cr4443/month  
PURCHASE COST: MCr53.3205  
...
| M-Drive (Thrust 1)      | 2    | 4          |
| J-Drive (Jump-2)        | 15   | 22.5       |
| Power Plant (Fusion, Power 105) | 7 | 7 |
| Fuel Tanks (J-2, 4 weeks operation) | 41 | — |
| Bridge                  | 10   | 1          |
| Computer (Computer/5bis)| —    | 0.045      |
| Sensors (Civilian Grade)| 1    | 3          |
...
| Common Areas (- Trophy Lounge) | 13 (7) | 1.3 (0.7) |
| Cargo                   | 14   | —          |

**Crew:** Pilot, Astrogator, Engineer, Medic, Steward  
**Hull:** 80  
**Running Costs:**  
MAINTENANCE COST: Cr5128/month  
PURCHASE COST: MCr61.5303  
...
TL15 | 200 tons, Standard, Reinforced

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 10         |
| Hull (Reinforced)       | —    | 5          |
| Armour (Crystaliron, Armour: 13) | 33 | 9.75 |
| M-Drive (Thrust 9)      | 18   | 36         |
| Power Plant (Fusion, Power 240) | 16 | 16 |
| Fuel Tanks (12 weeks operation) | 6 | — |
| Bridge                  | 10   | 1          |
| Computer (Computer/35)  | —    | 30         |
| Sensors (Improved, Countermeasures) | 5 | 12.3 |
| Weapons:                |      |            |
| • Triple Turret (beam lasers) | 1 | 2.5 |
| • Triple Turret (missile rack) | 1 | 3.25 |
...
**Hull:** 88  
**Running Costs:**  
MAINTENANCE COST: Cr11184/month  
PURCHASE COST: MCr134.217  
...
*Note: SDBs have no jump drives. Shifting them from system-to-system can be problematic. Some have jump shuttles that attach themselves to the boat and provide jump capability. Another method is simple transport in large bulk cargo carriers.*

---

### YACHT (TYPE: Y)
TL12 | 200 tons, Standard
...
| J-Drive (Jump-1)        | 10   | 15         |
| Power Plant (Fusion, Power 90) | 6 | 6 |
| Fuel Tanks (J-1, 8 weeks operation) | 22 | — |
| Bridge                  | 10   | 1          |
| Computer (Computer/5)   | —    | 0.03       |
| Sensors (Civilian Grade)| 1    | 3          |
| Weapons                 | —    | —          |
...
**Hull:** 80  
**Running Costs:**  
MAINTENANCE COST: Cr5584/month  
PURCHASE COST: MCr67.007  
...
TL15 | 400 tons, Standard, Reinforced

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 20         |
| Hull (Reinforced)       | —    | 10         |
| Armour (Crystaliron, Armour: 3) | 15 | 4.5 |
| M-Drive (Thrust 6)      | 24   | 48         |
| J-Drive (Jump-5)        | 55   | 82.5       |
| Power Plant (Fusion, Power 540) | 36 | 36 |
| Fuel Tanks (J-3, 8 weeks operation) | 128 | — |
| Bridge (Small)          | 10   | 1          |
...
| Systems:                |      |            |
| • Drop Tank Mount (80 tons) | 0.32 | 0.16 |
| • Fuel Processor (120 tons/day) | 6 | 0.3 |
| • Armoury               | 1    | 0.25       |
| • Fuel Scoops           | —    | 1          |
| Craft:                  |      |            |
| • Docking Space (20 tons)| 22  | 5.5        |
...
**Hull:** 176  
**Running Costs:**  
MAINTENANCE COST: Cr20750/month  
PURCHASE COST: MCr249.0003  
...
*Note: With the internal tankage Jump-3 can be achieved, with drop tanks Jump-5, with the drop tanks retained Jump-4.*

---

### LABORATORY SHIP (TYPE: L)
TL12 | 400 tons, Standard
...
| Power Plant (Fusion, Power 180) | 12 | 12 |
| Fuel Tanks (J-2, 4 weeks operation) | 82 | — |
| Bridge                  | 20   | 2          |
| Computer (Computer/10)  | —    | 0.16       |
| Sensors (Improved)      | 3    | 4.3        |
| Weapons                 | —    | —          |
| Systems:                |      |            |
| • Probe Drones x15      | 3    | 1.5        |
| • Docking Space (40 tons)| 44  | 11         |
| • Pinnace              | —    | 8.712      |
| • Laboratories          | 100  | 25         |
| • Docking Space (4 tons)| 5    | 1.25       |
| • Air/Raft              | —    | 0.25       |
| • ATV (stored in pinnace)| —  | 0.155      |
| Software:               |      |            |
| • Jump Control/2        | —    | 0.2        |
| • Library               | —    | —          |
| • Manoeuvre             | —    | —          |
...
**Hull:** 160  
**Running Costs:**  
MAINTENANCE COST: Cr11365/month  
PURCHASE COST: MCr136.3743  
...
*Note: This ship is built so internal gravity can be created by spinning the hull. This is done to permit experiments to be carried out that might otherwise be affected by the gravetic plates installed as standard on all ships.*

---

### PATROL CORVETTE (TYPE: T)
TL12 | 400 tons, Streamlined

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 24         |
| Armour (Crystaliron, Armour: 4) | 20 | 4.8 |
| M-Drive (Thrust 4)      | 16   | 32         |
| J-Drive (Jump-3)        | 35   | 52.5       |
| Power Plant (Fusion, Power 405) | 27 | 27 |
| Fuel Tanks (J-3, 4 weeks operation, plus Ship's Boat) | 124 | — |
| Bridge                  | 20   | 2          |
...
| • G/Carrier             | —    | 11.58      |
| • Fuel Scoop            | —    | —          |
| • Fuel Processors (80 tons a day) | 4 | 0.2 |
| Software:               |      |            |
| • Evade/1               | —    | 1          |
| • Fire Control/1        | —    | 2          |
| • Jump Control/3        | —    | 0.3        |
...
**Hull:** 160  
**Running Costs:**  
MAINTENANCE COST: Cr15371/month  
PURCHASE COST: MCr184.4568  
...
*Note: The auxiliary ship's boat and G/carrier on board, combined with a streamlined hull, allow the patrol corvette to pursue targets through atmospheres and down onto planetary surfaces, ensuring there is no escape.*
...
**Hull:** 160  
**Running Costs:**  
MAINTENANCE COST: Cr6529/month  
PURCHASE COST: MCr78.3423  
...
*Note: This ship normally requires a crew of five, although the pilot also operates the launch, a steward is only necessary if carrying commercial passengers and gunners may be added to the list if weapons are installed.*

---

### SURVEY SCOUT (CLASS: DONOSEV)
TL14 | 400 tons, Standard

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 20         |
| M-Drive (Thrust 2)      | 12   | 16         |
| J-Drive (Jump-3 reduced size x2) | 28 | 52.5 |
| Power Plant (Fusion, Power 210) | 14 | 14 |
| Fuel Tanks (J-3, 8 weeks operation) | 124 | — |
| Bridge                  | 20   | 2          |
...
**Hull:** 160  
**Running Costs:**  
MAINTENANCE COST: Cr12697/month  
PURCHASE COST: MCr152.3583  
...
*Note: The survey scout is a peaceful vessel, typically unarmed and inoffensive. It does, however, mount four hardpoints and can be armed with a variety of turrets and weaponry if necessary.*

---

### SUBSIDISED LINER (TYPE: M)
TL14 | 600 tons, Standard
...
| Power Plant (Fusion, Power 360) | 24 | 24 |
| Fuel Tanks (J-3, 4 weeks operation) | 183 | — |
| Bridge                  | 20   | 3          |
...
**Hull:** 240  
**Running Costs:**  
MAINTENANCE COST: Cr13193/month  
PURCHASE COST: MCr158.3163  

**Power Requirements:**
* Basic Ship Systems: 120
* Manoeuvre Drive: 60
* Jump Drive: 180
* Sensors: 1

*Note: Overall the ship is capable of carrying 24 passengers in addition to its crew, with a further 20 in low berths. Although the hull of the ship itself is understreamlined, a launch allows passengers to be ferried to the surface of a world or act as a life boat in emergencies.*

---

### MERCENARY CRUISER (TYPE: C)
TL12 | 800 tons, Sphere

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 32         |
| Armour (Crystaliron, Armour: 4) | 40 | 6.4 |
| M-Drive (Thrust 3)      | 24   | 48         |
| J-Drive (Jump-3)        | 65   | 97.5       |
| Power Plant (Fusion, Power 750) | 50 | 50 |
| Fuel Tanks (J-3, 4 weeks operation, fuel for Cutters) | 252 | — |
| Bridge                  | 20   | 4          |
| Computer (Computer/20fib)| —   | 7.5        |
| Sensors (Military Grade)| 2    | 4.1        |
| Weapons (Triple Turrets x8) | 8 | 8 |
| Systems:                |      |            |
| • Docking Space (4 tons)| 5    | 1.25       |
| • Air/Raft              | —    | 0.25       |
| • Docking Space (50 tons)| 55  | 13.75      |
...
**Hull:** 320  
**Running Costs:**  
MAINTENANCE COST: Cr24372/month  
...
*Note: The platoon can be deployed to a planet's surface within the two modular cutters housed inside the ship and can then disembark using the ATV's the two cutters carry. Turrets are fitted as standard but while shipyards do not generally include weapons, it is a rare mercenary cruiser that is not armed to the teeth.*
...
### LIGHT FIGHTER
TL12 | 10 tons, Streamlined

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 0.6        |
| Armour (Crystaliron, Armour: 2) | 0.25 | 0.06 |
| M-Drive (Thrust 6)      | 0.6  | 1.2        |
| Power Plant (Fusion, Power 15) | 1 | 1 |
...
**Hull:** 4  
**Running Costs:**  
MAINTENANCE COST: Cr758/month  
PURCHASE COST: MCr9.09  

**Power Requirements:**
* Basic Ship Systems: 2
* Manoeuvre Drive: 6
* Sensors: 2
* Weapons: 3

*Note: Designed to adhere to a strict budget, the Light Fighter allows even the poorest worlds a chance at self-defence.*

---

### GIG
TL12 | 20 tons, Streamlined

| Component               | Tons | Cost (MCr) |
|-------------------------|------|------------|
| Hull                    | —    | 1.2        |
| M-Drive (Thrust 7)      | 1.4  | 2.8        |
| Power Plant (Fusion, Power 30) | 2 | 2 |
| Fuel Tanks (4 weeks operation) | 1 | — |
| Bridge                  | 3    | 0.5        |
| Computer (Computer/5)   | —    | 0.03       |
| Sensors (Basic)         | —    | —          |
| Weapons (Single Turret, Empty) | 1 | 0.2 |
| Systems:                |      |            |
...
**Hull:** 8  
**Running Costs:**  
MAINTENANCE COST: Cr606/month  
PURCHASE COST: MCr7.272  

**Power Requirements:**
* Basic Ship Systems: 4
* Manoeuvre Drive: 14
* Turret: 1

*Note: Technically a vessel of the Imperial Navy, it is crewed by local starport personnel and used to perform orbital inspections and other light duties.*
...
**Hull:** 8  
**Running Costs:**  
MAINTENANCE COST: Cr197.25/month  
PURCHASE COST: MCr2.367  

**Power Requirements:**
* Basic Ship Systems: 4
* Manoeuvre Drive: 2

*Note: Also called a life boat, due to one of its expected roles. A launch can be configured to engage in a wide variety of roles but ambitious schemes will find themselves limited by the small hull and weak power plant.*

---

### SHIP'S BOAT
TL12 | 30 tons, Streamlined
...
**Hull:** 12  
**Running Costs:**  
MAINTENANCE COST: Cr591/month  
PURCHASE COST: MCr7.092  

**Power Requirements:**
* Basic Ship Systems: 6
* Manoeuvre Drive: 15

*Note: The ship's boat is both fast and versatile, making it a popular choice for auxiliary craft. While most commonly seen hauling small cargo and passenger loads between ships and worlds, in smaller militaries the ship's boat is also used as a boarding craft by marine assault teams.*
...
**Hull:** 12  
**Running Costs:**  
MAINTENANCE COST: Cr403.5/month  
PURCHASE COST: MCr4.842  

**Power Requirements:**
* Basic Ship Systems: 6
* Manoeuvre Drive: 9

*Note: Either way, the slow boat is comparable to the ship's boat but it trades speed for increased cargo space.*

---

### PINNACE
TL12 | 40 tons, Streamlined
...
|-------------------------|------|------------|
| Hull                    | —    | 2.4        |
| M-Drive (Thrust 3)      | 2.4  | 1.2        |
| Power Plant (Fusion, Power 20) | 2 | 1 |
| Fuel Tanks (4 weeks operation) | 1 | — |
| Bridge                  | 3    | 0.5        |
| Computer (Computer/5)   | —    | 0.03       |
| Sensors (Basic)         | —    | —          |
...
**Hull:** 20  
**Running Costs:**  
MAINTENANCE COST: Cr842/month  
PURCHASE COST: MCr10.107  

**Power Requirements:**
* Basic Ship Systems: 10
* Manoeuvre Drive: 20

*Note: The modular cutter is notable for having 30 tons dedicated to a detachable module; this allows the cutter to quickly and efficiently change roles during a voyage without needing extensive refits at a starport.*

**Common Modules:**
* ATV module: Costs MCr1.8
* Fuel module: Costs MCr1
* Open module: Costs MCr2

---

### SHUTTLE
TL12 | 95 tons, Streamlined
...
| Computer (Computer/5)   | —    | 0.03       |
| Sensors (Basic)         | —    | —          |
| Acceleration Bench (X60 - 240 passengers) | 60 | 0.6 |
| Systems                 | —    | —          |
| Software:               |      |            |
| • Library               | —    | —          |
| • Manoeuvre             | —    | —          |
...
**Hull:** 38  
**Running Costs:**  
MAINTENANCE COST: Cr827.25/month  
PURCHASE COST: MCr9.927  
...
*Note: Intended for routine passenger transport this shuttle fills the need at a reasonable price point. Capable of carrying up to 240 passengers. Normally only the passenger area is accessible to non-crew and operations are sufficiently routine that no stewards are carried.*
...
### INSTITUTE TESTING
A Traveller who wishes to develop psionic abilities requires training. In settings where psionics are uncommon or illegal, the Traveller must find a teacher, normally an underground Psionics Institute. Finding such an instructor can be an adventure in itself.
...
| Close           | 1 to 5 metres               |
| Short           | 6 to 10 metres              |
| Medium          | 11 to 50 metres             |
| Long            | 51 metres to 250 metres     |
| Very Long       | 251 metres to 500 metres    |
| Distant         | 501 metres to 5 kilometres  |
| Very Distant    | 6 kilometres to 500 kilometres |
| Continental     | 501 to 5,000 kilometres     |
| Planetary       | 5,001 to 50,000 kilometres  |

*Example: a psionic Traveller could read the mind of a target at Long range using Read Surface Thoughts for 2 PSI points normally, or boost it to Very Long range for 4 PSI points, or even Distant for 8 PSI points.*
...
### LIFE DETECTION
The most elementary form of telepathy is the ability to detect the presence of other minds. Life detection enables a Traveller to sense the presence of other minds, the number of minds present, the general type of minds (animal, human and so on) and their approximate location.
...
* Check: Easy (4+) Telepathy check (1D x 10 seconds, PSI)
* Reach: Distant
* PSI Cost: 1

### MIND LINK
This power is used by telepaths to communicate with one another – it is far easier to create a long lasting telepathic link to another telepath than to a mundane.

Both telepaths must use this power for it to work but once this is done, they may communicate silently with one another for a number of minutes equal to the combined Effects of their Telepathy checks.

* Check: Easy (4+) Telepathy check (1D seconds, PSI)
* Reach: Distant
* PSI Cost: 1
...
* Check: Routine (6+) Telepathy check (1D x 10 seconds, PSI)
* Reach: Long
* PSI Cost: 1
...
* Check: Difficult (10+) Telepathy check (1D x 10 seconds, PSI)
* Reach: Distant
* PSI Cost: 2
...
* Check: Very Difficult (12+) Telepathy check (1D x 10 seconds, PSI)
* Reach: Short
* PSI Cost: 3

### PROBE
The application of great psionic strength will enable a telepath to delve deep into the mind of a subject and to then read their innermost thoughts. Questioning can be used in the procedure to force the subject to divulge specific information. The telepath can easily determine deliberate untruths told (thought) by the subject.

Probe cannot be used against a shielded mind. Again, the Effect of the check determines the clarity of the telepath's perceptions.

* Check: Very Difficult (12+) Telepathy check (1D minutes, PSI)
* Reach: Close
* PSI Cost: 4
...
* Check: Formidable (14+) Telepathy check (1D seconds, PSI)
* Reach: Short
* PSI Cost: 8
...
Clairvoyance is a talent that allows a person to sense events at some location displaced from the viewer. There are several levels of clairvoyant ability. Clairvoyance powers allow eavesdropping activities as well as spying and detection-free exploration of situations. While telepathic life detection will determine the presence of living minds in a closed room, for example, sense will determine if a room is occupied or empty. Clairvoyant activity cannot be sensed by others, including by other psionic talented individuals.
...
* Check: Routine (6+) Clairvoyance check (1D x 10 seconds, PSI)
* Reach: Very Distant
* PSI Cost: 1

### TACTICAL AWARENESS
With this power, the Traveller can perceive dangers and foes around them using their clairvoyant abilities. This enhanced spatial perception allows them to ignore the effects of darkness, smoke, fog or other environmental effects that impede vision. They may also detect hidden foes within range. The Effect of the check determines the number of combat rounds the awareness lasts.

* Check: Average (8+) Clairvoyance check (1D seconds, PSI)
* Reach: Long
* PSI Cost: 2

### CLAIRVOYANCE
This specific power allows actual viewing of a situation at some displaced point. The clairvoyant Traveller must state the range at which they are applying this power. The Effect of the check determines the level of detail perceived.

* Check: Average (8+) Clairvoyance check (1D x 10 seconds, PSI)
* Reach: Very Distant
* PSI Cost: 1

### CLAIRAUDIENCE
This power is identical to clairvoyance, with the exception that it allows hearing instead of seeing.
...
### CLAIRSENTIENCE
A Traveller is capable of both seeing and hearing a specific situation by using this power.

* Check: Difficult (10+) Clairvoyance check (1D x 10 seconds, PSI)
* Reach: Very Distant
* PSI Cost: 1
...
### TELEKINESIS
This basic form of the talent allows the Traveller to move objects at range. The Effect of the check determines the duration of the telekinesis in combat rounds. The number of PSI points spent determines the mass that can be moved.

* Check: Average (8+) Telekinesis check (1D seconds, PSI)
* Reach: Short
* PSI Cost: 1 per 10kg

### FLIGHT
By applying telekinesis to their own body, the Traveller can fly, or at least levitate over short distances. The Traveller can fly for a number of rounds equal to the Effect of the check at a speed of 15 metres per round.

* Check: Difficult (10+) Telekinesis check (1D seconds, PSI)
* PSI Cost: 5

### TELEKINETIC PUNCH
Telekinesis can be used as a direct attack, smashing the foe with a blast of telekinetic force. The damage inflicted is equal to the Effect. Protection from any armour is applied as normal.
...
### MICROKINESIS
This more challenging form of telekinesis allows for fine manipulation of very small or even microscopic objects. A telekinetic can use this power to pick locks, perform microsurgery, sabotage a computer system and so forth.

* Check: Difficult (10+) Telekinesis check (1D x 10 seconds, PSI)
* Reach: Close
* PSI Cost: 3

### PYROKINESIS
By exciting the substance of an object, the Traveller can raise its temperature, possibly even causing it to burst into flames.

| Telekinesis Effect | Target... |
|--------------------|-----------|
| 0–4                | becomes warmer but is undamaged. |
| 5–8                | is burnt, suffering 1D damage. |
| 9+                 | suffers 2D damage and may burst into flame if flammable. |

* Check: Routine (6+) Telekinesis check (1D x 10 seconds, PSI)
* Reach: Short
* PSI Cost: 3
...
### ENHANCED STRENGTH
PSI points may be converted to STR points on a temporary basis. The Traveller makes the commitment, reduces their available PSI by a specified number of points and increases their STR characteristic by the same amount. STR reaches its new level immediately, remains at that peak for number of minutes equal to the Effect of the Awareness check x 10 and then declines at the rate of one point per minute until the Traveller's normal STR is reached.

* Check: Average (8+) Awareness check (1D seconds, PSI)
* PSI Cost: STR increase

### ENHANCED ENDURANCE
PSI points may be converted to END points on a temporary basis. The Traveller makes the commitment, reduces their available PSI by a specified number of points and increases their END characteristic by the same amount. END reaches its new level immediately, remains at that peak for number of minutes equal to the Effect of the Awareness check x 10 and then declines at the rate of one point per minute until the Traveller's normal END is reached.

* Check: Average (8+) Awareness check (1D seconds, PSI)
* PSI Cost: END increase

### FORTITUDE
By channeling psychic energy to their skeletal structure and boosting their healing rate, the Traveller can enhance their ability to absorb damage. Fortitude lasts a number of rounds equal to the Effect of the Awareness check and provides Protection equal to the number of PSI points expended. Fortitude stacks with worn armour.

* Check: Difficult (10+) Awareness check (1D seconds, PSI)
* PSI Cost: Amount of Armour

### INSPIRATION
Through both mental and physical activities, psionic enhancement can lead to flashes of inspiration, dexterous fine-tuning and momentarily toughened physique. Inspiration adds DM+2 to any one check the Traveller attempts within the next minute.

* Check: Average (8+) Awareness check (1D seconds, PSI)
* PSI Cost: 1

### REGENERATION
Wounds may be healed by the application of this power, exchanging one PSI point to regenerate one lost characteristic point. Should one session of healing be insufficient, further healing and regeneration may be applied after expended PSI is recovered. Regeneration may also be applied to the growing of new limbs or organs to replace lost ones or to heal old wounds suffered prior to psionic training. Regeneration may not be used to counteract ageing, nor may it be used to regain lost SOC.

* Check: Difficult (10+) Awareness check (1D x 10 seconds, PSI)
* PSI Cost: Amount healed
...
To teleport with clothing (but not armour) and up to 10kg of equipment, the Teleportation check is increased to Difficult (10+) and costs an additional 2 PSI.  
To teleport with clothing (but not armour) and up to 500kg of equipment, the Teleportation check is increased to Very Difficult (12+) and costs an additional 4 PSI.
...
Changes in altitude (actually all movement to locations of differing gravitational potential) will result in potential energy changes, manifesting themselves as alterations in body temperature. A jump of one kilometre straight down will result in an internal temperature increase of 2.5°C; this is sufficient to cause extreme fever, brain damage and even death. A jump upwards will cool the body by the same amount, with equally serious results. To be safe, a jump may not involve an elevation change of more than 400 metres and multiple jumps should not involve a cumulative elevation change or more than 600 metres in one hour. These problems may be circumvented somewhat through the use of technological devices such as energy compensators, heated suits and other means.
...
| Psi-Drug | PSI Restored | PSI Boosted | Cost   |
|----------|--------------|-------------|--------|
| Standard | 6            | +4          | Cr1000 |
| Double   | 9            | +6          | Cr4000 |
| Special  | 12           | +10         | Cr10000|
...
### INHIBITOR DRUG (TL9)
Psionic inhibitors dampen the brain's ability to generate psychic effects. A Traveller who takes (or, more often, is forcibly injected with) an inhibitor drug suffers DM-3 to all PSI-related checks and cannot regain PSI points. Each hour, the Traveller may make an END check to throw off the effects of the drug. Inhibitor drugs have no effect on non-psionic individuals. The drugs cost Cr500 per dose.

### PSIONIC SHIELD (TL12)
Any armour incorporating a helmet or hood can be outfitted with a psionic shield, automatically blocking all telepathy powers. This costs Cr4000. Buildings and vehicles can also be psionically shielded but this is much more costly, increasing the cost of the vehicle by 10%.

### PSIONIC INTERFACE (TL14)
...
| 1D | CASH BENEFITS | OTHER BENEFITS |
|----|---------------|----------------|
| 1  | Cr1000        | Gun            |
...
|------|---------|------------------------------------|
| 0    | —       | —                                  |
| 1    | Initiate| Science (psionicology) 1           |
| 2    | —       | —                                  |
...
| D66 | Passenger | D66 | Passenger |
|-----|-----------|-----|-----------|
| 11 | Refugee – Political | 41 | Ex-Scout |
| 12 | Refugee – Economic | 42 | Wanderer |
| 13 | Starting a New Life Offworld | 43 | Thief or Other Criminal |
| 14 | Mercenary | 44 | Scientist |
| 15 | Spy | 45 | Journalist or Researcher |
| 16 | Corporate Executive | 46 | Entertainer (Steward and Perform 1D–1 each) |
| 21 | Out to See the Universe | 51 | Gambler (Gambler 1D–1) |
| 22 | Tourist (1–3: Irritating, 4–6: Charming) | 52 | Rich Noble – Complains a Lot |
| 23 | Wide-Eyed Yokel | 53 | Rich Noble – Eccentric |
| 24 | Adventurer | 54 | Rich Noble – Raconteur |
| 25 | Explorer | 55 | Diplomat on a Mission |
| 26 | Claustrophobic | 56 | Agent on a Mission |
| 31 | Expectant Mother | 61 | Patron |
| 32 | Wants to Stowaway or Join the Crew | 62 | Alien |
| 33 | Possesses Something Dangerous or Illegal | 63 | Bounty Hunter |
| 34 | Causes Trouble (1–3: Drunkard, 4–5: Violent, 6: Insane) | 64 | On the Run |
| 35 | Unusually Pretty or Handsome | 65 | Wants to be on Board the Travellers' Ship for Some Reason |
| 36 | Engineer (Mechanic and Engineer 1D–1 each) | 66 | Hijacker or Pirate Agent |
...
* Major Cargo lots are composed of 1D x 10 tons of freight.
* Minor Cargo lots are composed of 1D x 5 tons of freight.
...
### MAIL
Mail is a special form of freight, consisting of large data storage drums that contain a vast amount of information, as well as physical packages, which must be transported from one world to another but not vital enough to be entrusted to the x-boat service or a private courier.

To determine if there is mail available, roll 2D and then apply the modifiers on the Mail table.
...
* Finding a Supplier or Broker: Average (8+) Broker check (1D days, EDU or SOC).
* Finding a Black Market Supplier or Broker of Illegal Goods: Average (8+) Streetwise check (1D days, EDU or SOC).
* Finding an Online Supplier or Broker (TL8+ worlds only): Average (8+) Admin check (1D hours, EDU).
...
Availability is influenced by the size of the market:
* On Population 3– apply DM–3 to the roll for quantity. This can result in a number of zero or less, reflecting no availability of even common goods.
* Conversely, Population 9+ worlds have vast economies and grant DM+3 on the roll for lot quantities.

A supplier will have all Common Goods available, the Trade Goods that match the world's Trade codes and a quantity of randomly determined goods equal to the Population code of the world. Roll on the Trade Goods table to randomly determine the goods available, re-rolling results 61–65 unless dealing with a black market supplier. If you roll the same type of goods multiple times, then the supplier has extra amounts of those goods available.
...
#### ILLEGAL GOODS
Some goods are illegal throughout the Imperium. These are marked as illegal in the Trade Goods tables. Other goods are illegal only on particular worlds (see Law Level, page 255).
...
| 63 | Drugs, Illegal | Asteroid, Desert, High Pop, Water World | 1D | Cr100000 | Asteroid+1, Desert+1, Garden+1, Water World+1 | Rich+6, High Population+6 | Addictive drugs, combat drugs |
...
| 66 | Exotics | — | — | — | — | — | Exotic goods are outside the normal trade rules, and covers such things are alien relics, prototype technology, unique plant or animal life, priceless treasures and so forth. Buying and selling exotic goods is a matter for roleplaying and adventure. |
...
| Asteroid             | Desert                           |
| Ice-Capped           | Non-Industrial                   |
| High Population      | Rich                             |
| Agricultural         | Garden                           |
| Waterworld           |                                  |
...
The term world refers to the various bodies contained in a stellar system; it encompasses planets, satellites and asteroid belts. For example, the single most important world in a system may not be a planet at all but a satellite of a gas giant or maybe a planetoid within an asteroid belt.
...
The basic planetary codes are Size, Atmosphere, Hydrographics, Population, Government, Law Level, Technology Level, Starport and Bases, and are generated using 2D each, with DMs applied based upon the results of other codes. These codes establish the basic identity of a world, as shown in Reading World Profiles. Additional information can be created and should be, to more fully describe a world.
...
| Admin | 64 |
| Advancement | 18 |
| Adventures and Campaigns | 4 |
| Advocate | 64 |
| Ageing | 48 |
| Airlocks | 152 |
| Aliens | 52 |
| Animals | 64, 84 |
| Animals of Alien Worlds | 86 |
| Art | 65 |
| Assignments | 22, 24, 26, 28 |
| Astrogation | 65 |
| Athletics | 65 |
| Atmosphere | 250 |
| Atmospheric Operations | 152 |
| Attack Step | 166 |
| Awareness | 233 |
| Background Skills | 9 |
| Bases | 259 |
| Basic Training | 18 |
| Benefits | 19, 46 |
| Boarding Actions | 175 |
| Boon and Bane | 61 |
| Broker | 66 |
| Buying a Ship | 149 |
| Called Shots | 169 |
| Campaign Ideas | 4 |
| Career Descriptions | 18 |
| Careers | 11 |
| Carouse | 66 |
| Changing Assignments | 20 |
| Changing Careers | 20 |
| Characteristic Modifiers | 9 |
| Characteristics | 9 |
| Charted Space | 3, 249, 258 |
| Clairvoyance | 231 |
| Combat | 138 |
| Combat Rounds | 164 |
| Commission | 19 |
| Contacts, Allies, Rivals and Enemies | 20 |
| Creation Summary | 8 |
| Credits | 97 |
| Crew Duties | 164 |
| Damage | 77 |
| Deception | 66 |
| Destructive Weapons | 78 |
| Diplomat | 66 |
| Docking and Landing | 152 |
| Dogfighting | 173 |
| Drifters and the Draft | 19 |
| Drive | 66 |
| Drugs | 115 |
| Dual Weapons | 78 |
| Effect | 61 |
...
| Encounters | 83, 155 |
| Engineer | 67 |
| Environmental Dangers | 80 |
| Events | 18 |
| Events During Pre-Career Education | 17 |
| Exciting Passengers | 240 |
| Explosives | 67 |
| Extended Actions | 75 |
| Facing and Fire Arcs | 165 |
| Fighter | 68 |
| Free Actions | 75 |
| Freight | 239 |
| Fuel | 156 |
| Further Reading | 5 |
| Galactic Directions | 247 |
| Gambler | 68 |
| Game Conventions | 5 |
| Government | 252 |
| Grappling | 78 |
...
| Healing | 82 |
| Heavy Weapons | 68 |
| Hull Configurations | 178 |
| Hydrographics | 251 |
| Illegal Goods | 243 |
| Initiative | 73, 165 |
| Injuries | 49 |
| Institute Testing | 228 |
| Investigate | 69 |
| Jack-of-All-Trades | 69 |
| Jump Travel | 157 |
| Language | 69 |
| Law Level | 255 |
| Leadership | 69 |
...
| Other Characters | 90 |
| Passengers | 158, 238 |
| Patrons and Missions | 93 |
| Persuade | 70 |
| Physical Characteristics | 9 |
| Pilot | 70 |
| Players and Travellers | 3 |
| Population | 252 |
| Post Career Education | 55 |
| Power | 152 |
| Pre-Career Education | 16 |
| Profession | 70 |
| Psionics and the Law | 228 |
| Psionic Strength | 228 |
| Psionic Talents | 229 |
| Psionic Technology | 234 |
| Qualification | 18 |
| Random Encounters | 94 |
| Ranks and Bonuses | 19 |
| Reading World Profiles | 248 |
| Recon | 71 |
| Remote Operations | 158 |
| Repairs | 159 |
| Rolling Characteristics | 9 |
| Routes and Jumps | 249 |
| Running Costs and Maintenance | 153 |
| Science | 71 |
| Scientific Toolkits | 121 |
| Seafarer | 71 |
| Sectors and Subsectors | 246 |
| Sensors | 160 |
| Ship Computers | 161 |
| Ship Shares | 48 |
| Ships with Benefits | 48 |
| Significant Actions | 74 |
| Size | 249 |
| Skill Limits | 18 |
| Skills | 9 |
| Skills and Training | 18 |
| Skills Packages | 50 |
| Social Standing and Nobility | 11 |
| Spacecraft | 149 |
| Spacecraft Equipment | 184 |
| Spacecraft Security | 161 |
| Special Powers | 230 |
| Specialties | 58 |
| Speculative Trade & Smuggling | 241 |
| Standards of Living | 98 |
| Starport | 257 |
| Starports and the Law | 258 |
| Starting a Battle | 165 |
| Stealth | 71 |
| Steward | 71 |
| Streetwise | 71 |
| Survival | 18, 72 |
...
| Task Chains | 63 |
| Task Checks | 58 |
| Task Difficulties | 60 |
| Tech Level | 6, 258 |
| Telekinesis | 232 |
| Telepathy | 230 |
| The Combat Round | 73 |
| The Connections Rule | 19 |
| The Imperium | 228 |
| The Referee | 3 |
| Timeframes | 62 |
| Toolkits | 120 |
| Trade Codes | 261 |
| Travel Calculations | 163 |
| Travel Codes | 260 |
| Traveller Rule Zero | 4 |
| Travel Times | 163 |
| Turrets and Fixed Mounts | 183 |
| University | 16 |
| Using the Psion Career | 229 |
| Vacc Suit | 72 |
| Weapons | 76 |
| Weapons and Screens | 183 |
| Weapon Traits | 79 |
| Where do I Come From? | 10 |
| Why Are You Travelling? | 52 |
| World Creation | 248 |
| World Temperature | 251 |

---

## EXPLORE THE EPIC STORY LINES OF TRAVELLER!

### DEEPNIGHT REVELATION
A grand 20 year campaign into deep space, commanding the exploration cruiser Deepnight Revelation.

Outfitted for the most stupendous mission in human history, a one-ship expedition will travel along the Great Rift to the edge of the Spiral Arm. Deepnight Revelation will explore the uncharted systems along its path; contact unknown species and weather unpredictable dangers.
...
### AND MANY MORE ADVENTURES IN CHARTED SPACE
There is also a growing number of standalone adventures set in many regions of the Charted Space universe that can be dropped into the middle of the published epic campaigns to extend them, or be used in campaigns of your own creation. From rescuing slaves to saving underwater cities, from investigating a vicious murder to recovering a spacecraft atop an active volcano, Traveller has an adventure that suits every style of play!

---

## WELCOME TO THE FAR FUTURE

*Traveller is a science-fiction roleplaying game of exploration, trade, and adventure in the far future. Players take on the roles of citizens of the Third Imperium and other interstellar societies, travelling between worlds and encountering strange new civilizations.*

*This core rulebook contains everything needed to play the game: character creation rules, skills, equipment, combat systems, spacecraft design and operation, world creation, trade rules, and psionics.*

*The universe awaits. Where will your Travellers go next?*