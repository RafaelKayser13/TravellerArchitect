...
export const WORLDS: World[] = [
  ...
  // FRANCE
  { name: 'Aurore', uwp: 'A483664-B', gravity: 0.47, gravityCode: 'Low', survivalDm: -2, path: 'Hard', nation: 'France', tier: 'Frontier', system: 'Eta Bootis', techLevel: 11 },
  { name: 'Beta Canum', uwp: 'A886885-C', gravity: 0.94, gravityCode: 'Normal', survivalDm: -1, path: 'Hard', nation: 'France', tier: 'Frontier', system: 'Beta Canum Venaticorum', techLevel: 12 },
  { name: 'Europe Neuve', uwp: 'A', gravity: 1.05, gravityCode: 'Normal', survivalDm: -2, path: 'Soft', nation: 'France', tier: 'Frontier', system: 'DM+4 123', techLevel: 10 }, 
  { name: 'Nous Voilà', uwp: 'A', gravity: 1.05, gravityCode: 'Normal', survivalDm: 0, path: 'Hard', nation: 'France', tier: 'Frontier', system: 'DM+4 123', techLevel: 9 },
  { name: 'Serurier', uwp: 'A', gravity: 0.21, gravityCode: 'Low', survivalDm: 0, path: 'Hard', nation: 'France', tier: 'Frontier', system: 'DM+4 123', techLevel: 8 },
  { name: 'Ville de Glace', uwp: 'A', gravity: 0.76, gravityCode: 'Low', survivalDm: 0, path: 'Hard', nation: 'France', tier: 'Frontier', system: 'DM+4 123', techLevel: 9 },

  // AMERICA
  { name: 'Ellis', uwp: 'A755755-C', gravity: 0.92, gravityCode: 'Normal', survivalDm: -1, path: 'Soft', nation: 'United States', tier: 'Frontier', system: 'Ellis', techLevel: 12 },
  { name: 'King (New Columbia)', uwp: 'A540544-C', gravity: 3.08, gravityCode: 'Extreme', survivalDm: -3, path: 'Soft', nation: 'United States', tier: 'Frontier', system: 'King', techLevel: 12 },
  { name: 'Hermes', uwp: 'A', gravity: 0.73, gravityCode: 'Low', survivalDm: -2, path: 'Soft', nation: 'United States', tier: 'Frontier', system: 'Hermes', techLevel: 11 },
  ...
  // AUSTRALIA
  { name: 'Botany Bay', uwp: 'A', gravity: 0.87, gravityCode: 'Normal', survivalDm: -1, path: 'Soft', nation: 'Australia', tier: 'Frontier', system: 'Delta Pavonis', techLevel: 11 }, 
  { name: 'Huntsland', uwp: 'A', gravity: 3.08, gravityCode: 'Extreme', survivalDm: -3, path: 'Soft', nation: 'Australia', tier: 'Frontier', system: 'Delta Pavonis', techLevel: 10 },
  { name: 'Kingsland', uwp: 'A', gravity: 1.07, gravityCode: 'Normal', survivalDm: -1, path: 'Soft', nation: 'Australia', tier: 'Frontier', system: 'Delta Pavonis', techLevel: 11 },

  // AZANIA
  { name: 'Naragema', uwp: 'A', gravity: 1.02, gravityCode: 'Normal', survivalDm: 0, path: 'Soft', nation: 'Azania', tier: 'Frontier', system: 'Epsilon Indi', techLevel: 10 },
  { name: 'Lubumbashi', uwp: 'A', gravity: 1.02, gravityCode: 'Normal', survivalDm: -1, path: 'Soft', nation: 'Azania', tier: 'Frontier', system: 'Epsilon Indi', techLevel: 11 },
  { name: 'Okavango', uwp: 'A', gravity: 0.94, gravityCode: 'Normal', survivalDm: -1, path: 'Soft', nation: 'Azania', tier: 'Frontier', system: 'Epsilon Indi', techLevel: 10 },
  ...
  // MANCHURIA
  { name: 'Chengdu', uwp: 'A', gravity: 0.93, gravityCode: 'Normal', survivalDm: -1, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 10 },
  { name: 'Cold Mountain', uwp: 'A', gravity: 0.83, gravityCode: 'Normal', survivalDm: -3, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 9 },
  { name: 'Dukou', uwp: 'A', gravity: 1.57, gravityCode: 'High', survivalDm: -2, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 8 },
  { name: 'Fuyuan', uwp: 'A', gravity: 0.71, gravityCode: 'Low', survivalDm: 0, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 10 },
  { name: 'Han', uwp: 'A', gravity: 0.92, gravityCode: 'Normal', survivalDm: -1, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 11 },
  { name: 'Kwantung', uwp: 'A', gravity: 0.93, gravityCode: 'Normal', survivalDm: 0, path: 'Hard', nation: 'Manchuria', tier: 'Frontier', system: 'Han Shan', techLevel: 12 },
